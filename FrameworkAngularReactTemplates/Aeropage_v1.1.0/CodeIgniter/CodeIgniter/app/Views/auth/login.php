...
<body>
<div class="relative bg-cover bg-center bg-no-repeat p-2 lg:p-0"
                    ...
                    <div class="p-6">
                        ...
                        <form action="<?= base_url('loginCheck') ?>" method="POST" class="mt-10 shrink">
                            ...
                            <?php if (!empty(session()->getFlashdata('error'))) : ?>
                                <div class="text-red-600 my-2 text-center"><?= session()->getFlashdata('error') ?></div>
                            <?php endif; ?>

                            <div class="mb-4">
                                <label for="LogInEmailAddress"
                                       class="mb-2 block text-base/normal font-semibold text-zinc-200">Email
                                    address</label>
                                <input data-x-field="email"
                                       ...
                                       type="email" id="LogInEmailAddress" placeholder="Enter your email" name="email"
                                       value="test@test.com"/>
                            ...
                            <div class="mb-6 flex flex-wrap items-center justify-between gap-x-1 gap-y-2">
                                <div class="inline-flex items-center">
                                    <input type="checkbox"
                                           ...
                                           id="checkbox-signin"/>
                                    <label class="ms-2 select-none align-middle text-base/none text-zinc-200"
                                           for="checkbox-signin">Remember me</label>
                                </div>
                                <a href="/auth-recoverpw" class="border-b border-dashed text-zinc-200"><small>Forgot
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                       class="group inline-flex size-12 items-center justify-center rounded-full bg-zinc-900 transition-all duration-300 hover:bg-blue-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                             stroke-linecap="round" stroke-linejoin="round" data-lucide="linkedin"
                        ...
                        <p class="shrink text-center text-zinc-200">
                            Don't have an account ?<a href="/auth-register"
                                                      class="ms-1 text-primary"><b>Register</b></a>
                        </p>
                    </div>
                </div>
            </div>
