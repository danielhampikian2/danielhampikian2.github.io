...
<?php echo view('partials/navbar',
  ...
  <!-- Hero Section Start -->
  <section id="home" class="relative flex items-center justify-center overflow-hidden bg-[url('../images/landing/marketing/bg-1.png')] bg-cover bg-no-repeat py-40 dark:bg-[url('../images/landing/marketing/bg-1-dark.jpg')]">
    <div class="container">
      <div class="relative">
        <div class="grid items-center gap-6 lg:grid-cols-2">
          <div class="mx-auto max-w-md text-center lg:ms-0 lg:text-start">
            <span class="rounded-md border border-default-300 px-3 py-1 text-xs font-medium uppercase tracking-wider text-default-900">startups Marketing</span>
            <h2 class="my-5 text-4xl font-medium text-default-900 md:text-5xl/tight">
            ...
            <a href="#" class="mt-6 inline-flex items-center justify-center gap-2 rounded-md border border-primary bg-primary/90 px-6 py-2 text-white transition-all duration-300 hover:bg-primary hover:text-default-950">Get Solution
          ...
          <div>
            <div class="tilt flex items-center gap-4 md:gap-6">
              <div class="flex w-full flex-col gap-4 md:gap-6">
                <img src="assets/images/landing/marketing/img-1.jpg" class="h-full w-full rounded-lg object-cover" alt="" />
              </div>
              <div class="relative flex w-full flex-col gap-4 pb-10 md:gap-6 md:pb-16">
                <img src="assets/images/landing/marketing/img-2.jpg" class="h-40 w-full rounded-lg object-cover md:h-[278px]" alt="" />
                <img src="assets/images/landing/marketing/img-3.jpg" class="h-40 w-full rounded-lg object-cover md:h-[278px]" alt="" />
              </div>
            </div>
            <!-- flex End -->
          </div>
  ...
  <!-- Start marq -->
  <section class="">
    <div class="relative m-auto flex gap-28 overflow-hidden border border-default-200 py-6">
    ...
    <div class="container">
      <div class="mb-10 flex items-end justify-between">
        <div class="mx-auto max-w-2xl text-center">
          <span class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Services</span>
      ...
      <div class="grid items-center gap-6 lg:grid-cols-2">
        <div>
          <div class="grid grid-cols-1 items-center overflow-hidden rounded-md border border-default-200">
            <div class="group">
              <div class="flex flex-wrap items-center gap-6 p-6">
                ...
                <div>
                  ...
                  <a href="javascript:void(0);" class="text-lg text-default-950">Read More
            ...
            <div class="group">
              <div class="flex flex-wrap items-center gap-6 p-6">
                <div>
                  <i data-lucide="boxes" class="size-14 text-default-950"></i>
                </div>
                <div>
                  <h2 class="mb-4 text-2xl font-medium text-default-950">
                    E-Commerce
        ...
        <div>
          <img src="assets/images/landing/marketing/img-4.jpg" class="mx-auto" alt="" />
        </div>
        <!-- col End -->
      </div>
      <!-- grid End -->
    ...
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <div class="relative h-[650px]">
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="
              background-image: url(&quot;assets/images/landing/marketing/img-5.jpg&quot;);
            ">
      ...
      <div class="py-10">
        <div class="max-w-lg px-10 md:ms-20">
          <span class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">About</span>
    ...
    <div class="container">
      <div>
          ...
          <div class="grid 2xl:grid-cols-2">
            <div class="divide-y divide-default-200">
              <div class="flex items-center justify-between p-6">
                ...
                <div>
                  <div class="flex size-12 cursor-pointer items-center justify-center rounded-md border border-default-200 bg-default-50 text-default-950 transition-all duration-300 hover:bg-white hover:text-primary">
        ...
        <div class="mt-7 flex justify-center">
          <a href="#" class="inline-flex items-center justify-center gap-2 rounded-md border border-default-200 px-8 py-2 text-default-950 backdrop-blur-3xl transition-all hover:border-primary hover:bg-primary hover:text-white">Get Solution
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="group relative overflow-hidden rounded-3xl">
              <img src="assets/images/landing/marketing/img-6.jpg" class="h-full w-full" alt="" />
              <div class="absolute inset-0 bg-black/40"></div>
              <div class="absolute inset-x-0 top-1/2 opacity-0 transition-all duration-700 group-hover:opacity-100">
                <div class="text-center">
                  <h5 class="mb-1 inline-block bg-default-50 px-3 py-1 text-xl font-medium text-default-950">
                    Brand
                  </h5>
                  <br />
                  <h2 class="inline-block bg-default-50 px-3 py-1 text-2xl font-medium text-default-950">
                    Coder Studio
                  </h2>
                </div>
              </div>
          ...
          <div class="swiper-slide">
            <div class="group relative overflow-hidden rounded-3xl">
              <img src="assets/images/landing/marketing/img-7.jpg" class="h-full w-full" alt="" />
              <div class="absolute inset-0 bg-black/40"></div>
              <div class="absolute inset-x-0 top-1/2 opacity-0 transition-all duration-700 group-hover:opacity-100">
                <div class="text-center">
                  <h5 class="mb-1 inline-block bg-default-50 px-3 py-1 text-xl font-medium text-default-950">
          ...
          <div class="swiper-slide">
            <div class="group relative overflow-hidden rounded-3xl">
              <img src="assets/images/landing/marketing/img-8.jpg" class="h-full w-full" alt="" />
              <div class="absolute inset-0 bg-black/40"></div>
              <div class="absolute inset-x-0 top-1/2 opacity-0 transition-all duration-700 group-hover:opacity-100">
                <div class="text-center">
                  <h5 class="mb-1 inline-block bg-default-50 px-3 py-1 text-xl font-medium text-default-950">
    ...
    <div class="container">
      ...
      <div class="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
        <div class="relative mb-20 lg:mb-0">
          <div class="relative">
            <img src="assets/images/landing/marketing/img-9.jpg" class="mx-auto" alt="" />
          </div>
          <div class="absolute inset-x-0 -bottom-14 hidden sm:block">
            <img src="assets/images/landing/marketing/img-10.jpg" class="h-full" alt="" />
          </div>
        </div>
        <!-- col End -->
      ...
      <div class="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
          ...
          <div class="swiper testimonials relative rounded-md">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="rounded-md bg-default-100 p-6 dark:bg-default-50">
                  <div class="flex items-center gap-5">
                    <img src="assets/images/avatars/img-3.jpg" class="size-14 rounded-full border-4 border-white/20" alt="" />
              ...
              <div class="swiper-slide">
                <div class="rounded-md bg-default-100 p-6 dark:bg-default-50">
                  <div class="flex items-center gap-5">
                    <img src="assets/images/avatars/img-2.jpg" class="size-14 rounded-full border-4 border-white/20" alt="" />
                    <h3 class="text-lg font-medium text-default-950">
                      Leonard Heiser
                    </h3>
                  </div>
          ...
          <div class="z-10 hidden pt-6 md:block">
            <div class="relative flex items-center justify-end gap-5 pe-10">
              <div class="testimonials-button-prev">
                <div class="flex size-14 items-center justify-center rounded-full bg-primary/90 text-white hover:bg-primary">
        ...
        <div class="me-0 lg:mx-auto">
          <div class="relative z-10">
            ...
            <img src="assets/images/landing/marketing/img-11.png" class="mx-auto rounded-full" alt="" />
          </div>
        </div>
        <!-- col End -->
      </div>
  ...
  <section id="blog" class="py-10 lg:py-20">
    <div class="container">
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
        ...
        <div class="overflow-hidden rounded-md border border-default-200">
          <div class="group">
            <img src="assets/images/landing/marketing/img-14.jpg" class="rounded" alt="" />
