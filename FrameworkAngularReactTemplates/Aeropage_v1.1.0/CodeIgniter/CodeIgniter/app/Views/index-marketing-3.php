...
<?php echo view('partials/navbar-two',
  ...
  <section id="home" class="relative overflow-hidden">
    <div class="px-4 md:px-10">
      <div class="overflow-hidden rounded-2xl bg-cover bg-center bg-no-repeat" style="
            ...
            <div class="relative p-6">
              <div class="flex h-full items-center justify-center py-36">
                <div class="relative mx-auto max-w-3xl text-center">
                  ...
                  <h1 class="mt-10 text-3xl font-medium text-white md:text-5xl/snug">
  ...
  <section id="solutions" class="py-10 lg:py-20">
    <div class="container">
      <div class="mx-auto mb-14 max-w-xl text-center">
        <span class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Business Solutions</span>
      ...
      <div class="relative m-auto flex gap-8 overflow-hidden">
        <div class="marquee__group flex min-w-full flex-shrink-0 items-center justify-around gap-8">
          ...
          <div class="w-60">
            <div class="rounded-xl bg-white p-6 text-center shadow-lg dark:bg-default-50">
              <div class="flex justify-center">
                <i data-lucide="folder-kanban" class="size-10 text-primary"></i>
              </div>
              <h4 class="mt-5 text-lg font-medium text-default-950">
          ...
          <div class="w-60">
            <div class="rounded-xl bg-white p-6 text-center shadow-lg dark:bg-default-50">
              <div class="flex justify-center">
                <i data-lucide="clipboard-signature" class="size-10 text-primary"></i>
              </div>
              <h4 class="mt-5 text-lg font-medium text-default-950">
  ...
  <section id="projects" class="overflow-hidden py-10">
    <div class="container">
      <div class="relative overflow-hidden rounded-3xl bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_24px] dark:bg-default-50">
        <div class="grid items-center gap-6 lg:grid-cols-2">
          <div class="relative p-6 text-center">
            ...
            <a href="#" class="inline-flex items-center justify-center gap-2 rounded-md bg-primary px-6 py-2 text-white transition-all duration-300 hover:bg-primary-700">Read More
              <i data-lucide="move-right" class="size-6"></i>
            </a>
          </div>
          <img src="assets/images/landing/marketing-3/img-2.jpg" class="h-full w-full" alt="" />
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="overflow-hidden py-10">
    <div class="container">
      <div class="relative overflow-hidden rounded-3xl bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_24px] dark:bg-default-50">
        <div class="grid items-center gap-6 lg:grid-cols-2">
          <img src="assets/images/landing/marketing-3/img-3.jpg" class="h-full w-full" alt="" />

          <div class="relative p-6">
            <span class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Exploratory Studies</span>
            <h2 class="mt-4 text-3xl font-medium text-default-950">
            ...
            <div>
              ...
              <div class="mt-1 flex h-4 w-full overflow-hidden rounded-full bg-default-200">
                <div class="flex flex-col justify-center overflow-hidden bg-primary" role="progressbar" style="width: 75%" aria-valuenow="46" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="my-10">
              ...
              <div class="mt-1 flex h-4 w-full overflow-hidden rounded-full bg-default-200">
                <div class="flex flex-col justify-center overflow-hidden bg-primary" role="progressbar" style="width: 95%" aria-valuenow="46" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="mt-1 flex h-4 w-full overflow-hidden rounded-full bg-default-200">
                <div class="flex flex-col justify-center overflow-hidden bg-primary" role="progressbar" style="width: 85%" aria-valuenow="46" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <section id="features" class="py-10 lg:py-20">
    <div class="container">
      <div class="grid items-center gap-6 lg:grid-cols-2">
        <div>
          <i data-lucide="activity-square" class="size-12 text-default-950"></i>
          ...
          <ul role="list" class="mt-6 text-sm text-default-700">
            <li class="flex items-center gap-2">
              ...
              <span class="text-base font-medium">99.9% Uptime Assurance</span>
            </li>
            <li class="flex items-center gap-2">
              <!-- svg icon -->
              <i data-lucide="dot" class="inline-block size-9 text-primary"></i>
              <span class="text-base font-medium">Endless Photos and Videos</span>
            </li>
            <li class="flex items-center gap-2">
              <!-- svg icon -->
              <i data-lucide="dot" class="inline-block size-9 text-primary"></i>
        ...
        <div class="h-[500px]">
          <img src="assets/images/landing/marketing-3/img-4.svg" class="h-full w-full" alt="" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="grid items-center gap-6 lg:grid-cols-2">
        <div>
          <div class="flex flex-wrap items-center justify-center gap-6">
            <div class="h-40 w-52 rounded-xl bg-purple-500/10 p-6 text-center">
              <div class="flex justify-center">
                <i data-lucide="shopping-bag" class="size-12 text-purple-600"></i>
              </div>
            ...
            <div class="h-40 w-52 rounded-xl bg-green-500/10 p-6 text-center md:-mt-14">
              <div class="flex justify-center">
                <i data-lucide="activity-square" class="size-12 text-green-600"></i>
              </div>
          ...
          <div class="mt-6 flex flex-wrap items-center justify-center gap-5">
            <div class="h-40 w-52 rounded-xl bg-red-500/10 p-6 text-center">
              <div class="flex justify-center">
                <i data-lucide="toggle-right" class="size-12 text-red-600"></i>
              </div>
              <h3 class="mt-3 text-xl font-medium text-red-600">
                Consultation
              </h3>
            </div>
            <div class="h-40 w-52 rounded-xl bg-sky-500/10 p-6 text-center md:-mt-14">
              <div class="flex justify-center">
        ...
        <div>
          ...
          <a href="#" class="inline-flex items-center justify-center gap-2 rounded-md bg-primary px-6 py-2 text-white transition-all hover:bg-primary-700">Read More
            <i data-lucide="move-right" class="size-6"></i>
          </a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="grid items-end gap-6 lg:grid-cols-2">
        ...
        <div class="relative mb-20 lg:mb-0">
          <div class="relative">
            <img src="assets/images/landing/marketing-3/img-5.jpg" class="mx-auto rounded-xl" alt="" />
          </div>
          <div class="absolute inset-x-0 -bottom-14 hidden sm:block">
            <img src="assets/images/landing/marketing-3/img-6.jpg" class="h-full rounded-xl" alt="" />
          </div>
        </div>
        <!-- col End -->
      </div>
  ...
  <section class="pb-10 pt-20">
    <div class="relative m-auto flex gap-10 overflow-hidden border-y border-default-200 py-8">
      <div class="marquee__group flex min-w-full flex-shrink-0 items-center justify-around gap-10">
        <div class="py-3">
      ...
      <div aria-hidden="true" class="marquee__group flex min-w-full flex-shrink-0 items-center justify-around gap-10">
        <div class="py-3">
          <h2 class="flex text-5xl font-medium text-default-950">
            Built for online marketing
          </h2>
    ...
    <div class="container">
      <div class="rounded-xl bg-primary/20 p-6">
        <div class="grid items-center gap-6 md:grid-cols-3">
          <div class="">
            <img src="assets/images/landing/marketing-3/img-7.png" class="max-w-full" alt="" />
          </div>
          <div class="md:col-span-2">
            <div class="flex flex-col">
              ...
              <div class="">
                <a href="#" class="inline-flex items-center justify-center gap-2 rounded-md bg-primary px-6 py-2 text-white transition-all hover:bg-primary-700">Sign up free
