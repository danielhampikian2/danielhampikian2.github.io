...
<?php echo view('partials/admin-page-title', array('title' => 'Chat', 'subtitle' => 'Admin')) ?>
        ...
        <div class="my-6 space-y-6">
            <div class="grid gap-4 lg:grid-cols-3">
                ...
                <div class="lg:col-span-1">
                    <div class="overflow-hidden rounded-xl border border-default-200 bg-white dark:bg-default-50 lg:min-w-96">
                        <div class="border-b border-default-200 px-6 py-4">
                            <h6 class="text-lg font-medium text-default-900">Contacts</h6>
                        </div>
                        <div class="h-[calc(100vh-370px)] divide-y divide-default-200 overflow-y-auto [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-default-300 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:w-1">
                            <div>
                                <div class="flex items-center gap-3 px-4 py-3">
                                    <img src="/assets/images/avatars/img-2.jpg" class="h-10 rounded-full"
                                         alt="Brandon Smith"/>
                                    <div class="w-full">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span class=""><span
                                                        class="rounded-full bg-red-500/25 px-1 py-0.5 text-xs text-red-500">3</span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="flex items-center gap-3 px-4 py-3">
                                    <img src="/assets/images/avatars/img-4.jpg" class="h-10 rounded-full"
                                         alt="Brandon Smith"/>
                                    <div class="w-full">
                                        <div class="flex justify-between">
                            ...
                            <div>
                                <div class="flex items-center gap-2 bg-default-100 px-4 py-3">
                                    <img src="/assets/images/avatars/img-5.jpg" class="h-10 rounded-full"
                                         alt=" John Kish"/>
                                    <div class="w-full">
                                        <div class="flex justify-between">
                            ...
                            <div>
                                <div class="flex items-center gap-3 px-4 py-3">
                                    <img src="/assets/images/avatars/img-7.jpg" class="h-10 rounded-full"
                                         alt="Maria C"/>
                                    <div class="w-full">
                                        <div class="flex justify-between">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span class=""><span
                                                        class="rounded-full bg-red-500/25 px-1 py-0.5 text-xs text-red-500">2</span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="flex items-center gap-3 px-4 py-3">
                                    <img src="/assets/images/avatars/img-6.jpg" class="h-10 rounded-full"
                                         alt="Rhonda D"/>
                                    <div class="w-full">
                                        <div class="flex justify-between">
                            ...
                            <div>
                                <div class="flex items-center gap-3 px-4 py-3">
                                    <img src="/assets/images/avatars/img-3.jpg" class="h-10 rounded-full"
                                         alt="Michael H"/>
                                    <div class="w-full">
                                        <div class="flex justify-between">
                            ...
                            <div>
                                <div class="flex items-center gap-3 px-4 py-3">
                                    <img src="/assets/images/avatars/img-8.jpg" class="h-10 rounded-full"
                                         alt="Michael H"/>
                                    <div class="w-full">
                                        <div class="flex justify-between">
                ...
                <div class="lg:col-span-2">
                    <div class="w-full overflow-hidden rounded-xl border border-default-200 bg-white dark:bg-default-50">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-3 py-1.5">
                                <div class="sm:w-7/12">
                                    <div class="flex items-center gap-2">
                                        <img src="/assets/images/avatars/img-5.jpg" class="me-2 h-9 rounded-full"
                                             alt="Brandon Smith"/>
                                        <div>
                                            ...
                                            <p class="mt-1.5 flex items-center text-xs text-default-400">
                                                <small class="ti ti-circle-filled me-1 text-red-400"></small>
                                                Offline
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="h-[calc(100vh-480px)] overflow-y-auto p-6 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-default-300 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:w-1">
                            <div class="space-y-4">
                                <!-- Chat Left -->
                                <div class="group flex w-11/12 items-start gap-3 text-start">
                                    <div class="text-center">
                                        <img src="/assets/images/avatars/img-5.jpg" class="h-8 rounded-md"/>
                                ...
                                <!-- Chat Right -->
                                <div class="group ms-auto flex w-11/12 flex-row-reverse items-start gap-3 text-end">
                                    <div class="text-center">
                                        <img src="/assets/images/avatars/img-1.jpg" class="h-8 rounded-md"/>
                                ...
                                <div class="group flex w-11/12 items-start gap-3 text-start">
                                    ...
                                    <div class="max-w-3/4 rounded bg-default-100 p-3">
                                        <p class="relative block text-xs font-bold text-default-800">
                                            John K
                                        </p>
                                            ...
                                            <div class="p-3">
                                                <div class="flex items-center justify-between gap-3">
                                                    <div class="flex items-center gap-3">
                                                        <div class="size-12">
                                <span class="inline-flex h-full w-full items-center justify-center rounded bg-primary text-white">
                                  .ZIP
                                </span>
                                                        </div>
                        ...
                        <div class="border-t border-default-200 bg-white p-6 dark:bg-default-50">
                            <form name="chat-form" class="flex items-center gap-2">
                                ...
                                <div class="flex w-auto gap-1">
                                    <a href="#"
                                       class="rounded bg-default-200 px-3 py-2 text-default-800 hover:bg-default-800/20"><i
                                                class="ti ti-paperclip"></i></a>
                                    <button class="inline-flex items-center justify-center gap-2 rounded bg-primary px-3 py-2 text-white transition-all duration-300 hover:bg-primary-700">
