...
<?php echo view('partials/navbar',
  ...
  <!-- Hero Section Start -->
  <section id="home" class="bg-[url('../images/other/bg-lines-2.png')] bg-cover bg-no-repeat dark:bg-[url('../images/other/bg-lines-2-dark.png')]">
        ...
        <div class="swiper mySwiper swiper-hero">
          <div class="swiper-wrapper">
            <div class="swiper-slide relative">
              <img src="assets/images/landing/creative/img-2.jpg" class="h-full w-full" />
              <div class="absolute inset-0 bg-black/40"></div>
            </div>
            <!-- swiper-slide end -->

            <div class="swiper-slide relative">
              <img src="assets/images/landing/creative/img-3.jpg" class="h-full w-full" />
              <div class="absolute inset-0 bg-black/40"></div>
            </div>
            <!-- swiper-slide end -->

            <div class="swiper-slide relative">
              <img src="assets/images/landing/creative/img-1.jpg" class="h-full w-full" />
              <div class="absolute inset-0 bg-black/40"></div>
            </div>
            <!-- swiper-slide end -->
          </div>
        ...
        <div class="swiper mySwiper2 swiper-hero relative me-10">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="flex flex-col items-start justify-end pb-28 xl:h-full">
                <!-- <span class="text-base font-medium uppercase tracking-wider text-default-800">Digital agency</span> -->
                <h2 class="mt-6 max-w-2xl text-4xl font-semibold text-default-950">
        ...
        <div class="absolute inset-x-0 bottom-8 z-10">
          <div class="relative flex items-center justify-end gap-5 pe-10">
            <div class="cre-button-prev">
              <div class="flex size-14 items-center justify-center rounded-full border border-default-200 bg-default-50 text-default-900 hover:bg-primary hover:text-white">
    ...
    <div class="container">
      <div class="mb-10 flex items-end justify-between">
        <div class="mx-auto max-w-2xl text-center">
          <span class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Featureo Features</span>
      ...
      <div class="grid grid-cols-1 items-center overflow-hidden rounded-md border border-default-200 md:grid-cols-2 xl:grid-cols-3">
        <div class="group h-full border-b border-default-200">
          <div class="p-8 sm:p-10">
            <span class="">
              <i data-lucide="component" class="size-14 text-default-950"></i>
            </span>
        ...
        <div class="group h-full border-b border-s border-default-200 xl:border-0">
          <div class="p-8 sm:p-10">
            <span class="">
              <i data-lucide="layout-grid" class="size-14 text-default-950"></i>
            </span>
            <h2 class="mb-4 mt-8 text-2xl font-medium text-default-950">
              Branding & Design
            </h2>
        ...
        <div class="group h-full border-b border-default-200 md:border-b-0 xl:border-s">
          <div class="p-8 sm:p-10">
            <span class="">
        ...
        <div class="group h-full border-default-200 md:border-s">
          <div class="p-8 sm:p-10">
            <span class="">
              <i data-lucide="paintbrush" class="size-14 text-default-950"></i>
            </span>
            <h2 class="mb-4 mt-8 text-2xl font-medium text-default-950">
              Graphic Design
            </h2>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="group relative overflow-hidden rounded-xl">
              <img src="assets/images/landing/creative/img-2.jpg" class="h-full w-full" alt="" />
              <div class="absolute inset-0 bg-black/60"></div>
              <div class="absolute inset-x-0 top-1/2 opacity-0 transition-all duration-700 group-hover:opacity-100">
                <div class="text-center">
                  <h5 class="mb-1 inline-block bg-black px-3 py-1 text-xl font-medium text-white">
                    Brand
                  </h5>
                  <br />
                  <h2 class="inline-block bg-black px-3 py-1 text-2xl font-medium text-white">
                    Coder Studio
                  </h2>
                </div>
              </div>
          ...
          <div class="swiper-slide">
            <div class="group relative overflow-hidden rounded-xl">
              <img src="assets/images/landing/creative/img-4.jpg" class="h-full w-full" alt="" />
              <div class="absolute inset-0 bg-black/60"></div>
              <div class="absolute inset-x-0 top-1/2 opacity-0 transition-all duration-700 group-hover:opacity-100">
                <div class="text-center">
                  <h5 class="mb-1 inline-block bg-black px-3 py-1 text-xl font-medium text-white">
          ...
          <div class="swiper-slide">
            <div class="group relative overflow-hidden rounded-xl">
              <img src="assets/images/landing/creative/img-5.jpg" class="h-full w-full" alt="" />
              <div class="absolute inset-0 bg-black/60"></div>
              <div class="absolute inset-x-0 top-1/2 opacity-0 transition-all duration-700 group-hover:opacity-100">
                <div class="text-center">
                  <h5 class="mb-1 inline-block bg-black px-3 py-1 text-xl font-medium text-white">
    ...
    <div class="container">
      <div class="grid grid-cols-1 gap-10 lg:grid-cols-2">
        ...
        <div class="relative overflow-hidden rounded-md">
          <img src="assets/images/landing/creative/img-3.jpg" class="h-full w-full rounded-md" alt="" />
          <div class="absolute inset-0 bg-black/60"></div>
        </div>
        <!-- col End -->
      </div>
      ...
      <div class="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
        <div class="mx-auto">
          <div class="relative z-10">
            <div class="absolute inset-y-0 -start-20 -z-10 hidden h-full w-full rounded-full border-2 border-default-200 sm:block"></div>
            <img src="assets/images/landing/creative/img-6.png" class="rounded-full" alt="" />
          </div>
        </div>
        <!-- col End -->
              ...
              <div class="swiper-slide">
                <div class="rounded-md bg-default-50 p-6">
                  ...
                  <div class="mt-4 flex items-center gap-2">
                    <i data-lucide="star" class="size-5 fill-current text-yellow-300"></i>
                    <i data-lucide="star" class="size-5 fill-current text-yellow-300"></i>
                    <i data-lucide="star" class="size-5 fill-current text-yellow-300"></i>
                    <i data-lucide="star" class="size-5 fill-current text-yellow-300"></i>
                    <i data-lucide="star" class="size-5 fill-current text-yellow-300"></i>
    ...
    <div class="container">
      ...
      <div class="relative">
        <div class="hidden lg:block">
          <div class="before:absolute before:-start-10 before:-top-10 before:h-24 before:w-24 before:bg-[url('../images/other/dot.svg')]"></div>
          <div class="after:absolute after:-bottom-10 after:-end-10 after:h-24 after:w-24 after:bg-[url('../images/other/dot.svg')]"></div>
        </div>

        <div class="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
          <div>
            <div class="relative z-10">
              <img src="assets/images/landing/creative/img-2.jpg" class="h-full rounded-md shadow lg:h-72" alt="" />
            </div>
            <div class="-mt-28 hidden xl:block">
              <img src="assets/images/landing/creative/img-7.jpg" class="ms-auto h-72 rounded-md shadow" alt="" />
            </div>
          </div>
          <!-- col End -->
          ...
          <div>
            <div class="hs-accordion-group space-y-4">
              <div class="hs-accordion overflow-hidden rounded-lg border border-default-200 bg-default-50 backdrop-blur-3xl" id="faq-2">
                <button class="hs-accordion-toggle inline-flex w-full items-center justify-between gap-x-3 px-6 py-4 text-left capitalize text-default-950 transition-all" aria-controls="faq-2">
                  <h5 class="flex text-base font-medium">
                    <i data-lucide="help-circle" class="me-3 size-5 stroke-default-950 align-middle"></i>
              ...
              <div class="hs-accordion overflow-hidden rounded-lg border border-default-200 bg-default-50 backdrop-blur-3xl" id="faq-3">
              ...
              <div class="hs-accordion active overflow-hidden rounded-lg border border-default-200 bg-default-50 backdrop-blur-3xl" id="faq-1">
      ...
      <div class="grid gap-6 xl:grid-cols-2">
        <div class="rounded-md border border-default-200 p-6">
          <div class="grid items-center gap-6 sm:grid-cols-5">
            <div class="col-span-2">
              <img src="assets/images/landing/creative/img-6.png" class="my-auto h-full w-full rounded-md" alt="" />
            </div>
            ...
            <div class="group sm:col-span-3">
              ...
              <a href="javascript:void(0);" class="text-lg font-medium text-default-950">Read More
                <i data-lucide="move-right" class="inline-block size-4 opacity-0 transition-all duration-500 will-change-transform group-hover:translate-x-2 group-hover:opacity-100"></i>
              </a>
            </div>
            <!-- col-span-2 End -->
          </div>
        ...
        <div class="rounded-md border border-default-200 p-6">
          <div class="grid items-center gap-6 sm:grid-cols-5">
            ...
            <div class="col-span-2">
              <img src="assets/images/landing/creative/img-8.png" class="my-auto h-full w-full rounded-md" alt="" />
            </div>
          </div>
          <!-- grid End -->
        </div>
