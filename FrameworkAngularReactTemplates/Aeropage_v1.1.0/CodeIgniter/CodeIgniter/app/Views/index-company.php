...
<?php echo view('partials/navbar-two',
  ...
  <!-- Hero Section Start -->
  <section id="home" class="relative overflow-hidden bg-primary/5 py-24 lg:py-40">
    <div class="container">
        ...
        <div class="max-w-xl">
          <div class="inline-block rounded-full border border-primary/20 pe-5">
            <div class="flex items-center gap-2">
              ...
              <span class="text-xs font-medium text-default-950 md:text-sm">Startup Business</span>
            </div>
          </div>
          ...
          <div class="inline-block">
            <a href="#" class="mt-6 flex items-center justify-center gap-2 rounded-md bg-primary px-6 py-2 text-base font-medium text-white transition-all duration-300 hover:bg-primary-700">Get started now</a>
          </div>
        </div>
        <!-- col End -->
      ...
      <div class="grid gap-6 lg:grid-cols-3">
        <div class="rounded-xl border border-primary/20 bg-primary/5 p-6 text-center sm:text-start">
          <div class="flex flex-wrap items-center justify-center gap-6 sm:flex-nowrap sm:justify-start sm:gap-0">
            <div class="sm:pe-5">
              <i data-lucide="settings" class="mx-auto size-10 text-default-950"></i>
            </div>
        ...
        <div class="rounded-xl border border-primary/20 bg-primary/5 p-6 text-center sm:text-start">
          <div class="flex flex-wrap items-center justify-center gap-6 sm:flex-nowrap sm:justify-start sm:gap-0">
            <div class="sm:pe-5">
              <i data-lucide="app-window" class="mx-auto size-10 text-default-950"></i>
            </div>
        ...
        <div class="rounded-xl border border-primary/20 bg-primary/5 p-6 text-center sm:text-start">
          <div class="flex flex-wrap items-center justify-center gap-6 sm:flex-nowrap sm:justify-start sm:gap-0">
            <div class="sm:pe-5">
              <i data-lucide="headphones" class="mx-auto size-10 text-default-950"></i>
            </div>
  ...
  <section class="bg-default-100 bg-[url('../images/other/bg-lines-2.png')] bg-cover bg-no-repeat py-10 dark:bg-default-50 dark:bg-[url('../images/other/bg-lines-2-dark.png')] lg:py-20">
    <div class="container">
      <div class="grid grid-cols-1 items-center gap-6 xl:grid-cols-2">
        <div>
          ...
          <a href="#" class="inline-flex h-10 items-center justify-center rounded-md bg-primary/20 px-4 text-primary transition-all hover:bg-primary hover:text-white">
        ...
        <div class="rounded-lg p-8">
          <div class="rounded-md bg-white p-6 dark:bg-default-100">
            ...
            <form class="mt-6 space-y-4">
              <div>
                <label for="name" class="mb-2 inline-block text-base font-medium text-default-950">Name</label>
                <input type="text" id="name" class="h-12 w-full rounded border-default-200 py-4 ps-4 text-default-950 focus:border-default-200 focus:ring-0 dark:bg-default-50" placeholder="Your Name" name="name" />
              </div>
              <div>
                <label for="email" class="mb-2 inline-block text-base font-medium text-default-950">Email</label>
                <input type="email" id="email" class="h-12 w-full rounded border-default-200 py-4 ps-4 text-default-950 focus:border-default-200 focus:ring-0 dark:bg-default-50" placeholder="Type Your email" name="email" />
              </div>
              <div>
                <label for="subject" class="mb-2 inline-block text-base font-medium text-default-950">Subject</label>
                <input type="text" id="subject" class="h-12 w-full rounded border-default-200 py-4 ps-4 text-default-950 focus:border-default-200 focus:ring-0 dark:bg-default-50" placeholder="Your message subject" name="subject" />
              </div>
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 2xl:grid-cols-3">
        <div class="rounded-lg bg-default-100 text-center dark:bg-default-50">
          <div class="p-6">
            ...
            <h3 class="mb-4 mt-6 text-xl font-medium text-default-950 md:text-2xl">
              Fuel Delivery
            </h3>
            ...
            <a href="javascript:void(0);" class="inline-flex items-center gap-2 text-lg font-medium text-default-950">Read more <i data-lucide="move-right" class="size-5"></i></a>
          </div>
        </div>
        <!-- col End -->
        ...
        <div class="rounded-lg bg-default-100 text-center dark:bg-default-50">
          <div class="p-6">
            <div class="flex justify-center">
              <i data-lucide="database" class="size-12 text-default-950"></i>
            </div>
            <h3 class="mb-4 mt-6 text-xl font-medium text-default-950 md:text-2xl">
        ...
        <div class="rounded-lg bg-default-100 text-center dark:bg-default-50">
          <div class="p-6">
            <div class="flex justify-center">
              <i data-lucide="codesandbox" class="size-12 text-default-950"></i>
            </div>
            <h3 class="mb-4 mt-6 text-xl font-medium text-default-950 md:text-2xl">
    ...
    <div class="container">
      <div class="relative z-20">
        <div class="hidden xl:block">
          <div class="before:absolute before:-end-10 before:-top-10 before:-z-10 before:h-24 before:w-24 before:bg-[url('../images/landing/company/dot.svg')] after:absolute after:-bottom-10 after:-start-10 after:-z-10 after:h-24 after:w-24 after:bg-[url('../images/landing/company/dot.svg')]"></div>
        </div>

        <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
          <div>
            <img src="assets/images/landing/company/img-2.jpg" alt="" class="rounded-lg" />
          </div>
          <!-- col End -->
  ...
  <section id="faq" class="py-10 lg:py-20">
    <div class="container">
      ...
      <div class="grid grid-cols-1 items-center gap-6 lg:grid-cols-2 lg:gap-12">
        <div>
          <div class="hs-accordion-group space-y-4">
            <div class="hs-accordion active overflow-hidden rounded-lg border border-default-200 bg-white dark:bg-default-50" id="faq-1">
              <button class="hs-accordion-toggle inline-flex w-full items-center justify-between gap-x-3 px-6 py-4 text-left capitalize text-default-950 transition-all" aria-controls="faq-accordion-1">
                ...
                <i data-lucide="chevron-up" class="size-4 transition-all duration-300 hs-accordion-active:-rotate-180"></i>
              </button>
        ...
        <div class="relative mb-20 lg:mb-0">
          <div class="relative">
            <img src="assets/images/landing/company/img-4.jpg" class="mx-auto rounded-lg" alt="" />
          </div>
          <div class="absolute inset-x-0 -bottom-14 hidden sm:block">
            <img src="assets/images/landing/company/img-3.jpg" class="h-full rounded-lg" alt="" />
          </div>
        </div>
        <!-- col End -->
      </div>
  ...
  <section id="testimonials">
    <div class="container">
      <div class="rounded-lg bg-default-100 dark:bg-default-50">
        <div class="bg-[url('../images/other/bg-lines-2.png')] bg-cover bg-no-repeat p-10 dark:bg-[url('../images/other/bg-lines-2-dark.png')] md:p-20">
          ...
          <div class="relative">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="mx-auto max-w-4xl text-center">
                    <div class="p-6">
                      <i data-lucide="quote" class="mx-auto size-9 text-default-400"></i>
                      ...
                      <img src="assets/images/avatars/img-1.jpg" class="mx-auto size-14 rounded-full" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="mx-auto max-w-4xl text-center">
                    <div class="p-6">
                      ...
                      <img src="assets/images/avatars/img-2.jpg" class="mx-auto size-14 rounded-full" alt="" />
                      <h3 class="mt-5 text-xl font-medium text-default-950">
                        Rashed ka.
                      </h3>
                ...
                <div class="swiper-slide">
                  <div class="mx-auto max-w-4xl text-center">
                    <div class="p-6">
                      ...
                      <img src="assets/images/avatars/img-3.jpg" class="mx-auto size-14 rounded-full" alt="" />
                      <h3 class="mt-5 text-xl font-medium text-default-950">
                        Jackma Kalin
                      </h3>
            ...
            <div class="absolute start-0 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2">
            ...
            <div class="absolute end-0 top-1/2 z-10 -translate-y-1/2 translate-x-1/2">
        ...
        <div class="swiper testimonials_swiper relative">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="mx-auto max-w-4xl text-center">
                <div class="mb-5">
                  <img src="assets/images/landing/company/img-5.jpg" class="rounded-lg" alt="" />
                </div>
                <a href="#" class="text-xl font-medium text-default-950">10 Easy Habits to Enhance Your Daily Progress by 1%</a>
              </div>
            </div>
            <!-- swiper-slide End -->
            ...
            <div class="swiper-slide">
              <div class="mx-auto max-w-4xl text-center">
                <div class="mb-5">
                  <img src="assets/images/landing/company/img-6.jpg" class="rounded-lg" alt="" />
                </div>
                <a href="#" class="mt-5 text-xl font-medium text-default-950">5 Mind-Blowing Applications of Artificial Intelligence</a>
              </div>
            </div>
            <!-- swiper-slide End -->
            ...
            <div class="swiper-slide">
              <div class="mx-auto max-w-4xl text-center">
                <div class="mb-5">
                  <img src="assets/images/landing/company/img-7.jpg" class="rounded-lg" alt="" />
                </div>
                <a href="#" class="mt-5 text-xl font-medium text-default-950">This Highly Anticipated Technology Could Finally Transform
                  the World</a>
              </div>
            </div>
            <!-- swiper-slide End -->
            ...
            <div class="swiper-slide">
              <div class="mx-auto max-w-4xl text-center">
                <div class="mb-5">
                  <img src="assets/images/landing/company/img-8.jpg" class="rounded-lg" alt="" />
                </div>
                <a href="#" class="mt-5 text-xl font-medium text-default-950">Design Thinking: Crafting a Design System for an
            ...
            <div class="swiper-slide">
              <div class="mx-auto max-w-4xl text-center">
                <div class="mb-5">
                  <img src="assets/images/landing/company/img-9.jpg" class="rounded-lg" alt="" />
                </div>
                <a href="#" class="mt-5 text-xl font-medium text-default-950">If You Possess Self-Discipline, Begin Cultivating These 4
                  Habits Now</a>
              </div>
            </div>
            <!-- swiper-slide End -->
            ...
            <div class="swiper-slide">
              <div class="mx-auto max-w-4xl text-center">
                <div class="mb-5">
                  <img src="assets/images/landing/company/img-10.jpg" class="rounded-lg" alt="" />
                </div>
                <a href="#" class="mt-5 text-xl font-medium text-default-950">This Highly Anticipated Technology Could Finally Transform
                  the World</a>
              </div>
