...
<?php echo view('partials/navbar',
  ...
  <section class="py-10 lg:py-20">
    <div class="container">
      <div class="bg-default-100 dark:bg-default-50">
        <div class="bg-[url('../images/other/bg-lines-2.png')] bg-cover bg-no-repeat px-6 py-20 dark:bg-[url('../images/other/bg-lines-2-dark.png')]">
  ...
  <section id="testimonial">
    <div class="container">
      <div class="bg-default-100 dark:bg-default-50">
        <div class="bg-[url('../images/other/bg-lines-2.png')] bg-cover bg-no-repeat py-20 dark:bg-[url('../images/other/bg-lines-2-dark.png')]">
          <div class="relative">
            <!--Start Swiper -->
  ...
  <section class="py-10 lg:py-20">
    <div class="container">
      ...
      <div class="bg-default-100 dark:bg-default-50">
        <div class="bg-[url('../images/other/bg-lines-2.png')] bg-cover bg-no-repeat p-10 text-center dark:bg-[url('../images/other/bg-lines-2-dark.png')] md:p-20">
          <h2 class="text-3xl font-medium text-default-950 md:text-4xl">
