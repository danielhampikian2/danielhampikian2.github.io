...
<?php echo view('partials/navbar-two',
      ...
      <div class="container">
        <div class="p-6">
          <div class="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              <span class="bg-primary/10 px-3 py-1 text-sm font-medium uppercase tracking-wider text-primary shadow">Animals Frame</span>
              <h1 class="my-4 max-w-lg text-4xl font-medium text-default-950 md:text-5xl/tight">
              ...
              <a href="#" class="group mt-10 inline-flex items-center justify-center gap-2 rounded-full border border-default-200 px-1 py-1 pe-4 text-default-950 transition-all duration-300 hover:bg-primary-600 hover:text-white">
                <span class="me-2 flex size-11 items-center justify-center rounded-full bg-primary/20 text-primary transition-all duration-300 group-hover:bg-white group-hover:text-black">
              ...
              <div class="marquee grid grid-cols-2 gap-6">
                <div class="relative m-auto flex flex-col gap-6 overflow-hidden">
                  <div class="marquee-hero flex min-h-full flex-shrink-0 flex-col items-center justify-around gap-6">
                    <img class="aspect-1 h-full w-60 object-cover" src="assets/images/landing/photography/img-1.jpg" alt="" />
                    <img class="aspect-1 h-full w-60 object-cover" src="assets/images/landing/photography/img-2.jpg" alt="" />
                    <img class="aspect-1 h-full w-60 object-cover" src="assets/images/landing/photography/img-3.jpg" alt="" />
                    <img class="aspect-1 h-full w-60 object-cover" src="assets/images/landing/photography/img-4.jpg" alt="" />
                    <img class="aspect-1 h-full w-60 object-cover" src="assets/images/landing/photography/img-5.jpg" alt="" />
                    <img class="aspect-1 h-full w-60 object-cover" src="assets/images/landing/photography/img-6.jpg" alt="" />
                  </div>
  ...
  <section id="about" class="py-10 lg:py-20">
    <div class="container">
      <div class="grid grid-cols-1 items-end gap-6 lg:grid-cols-2">
        <div>
          <img src="assets/images/landing/photography/img-7.jpg" alt="" />
        </div>
        <!-- col End -->
        ...
        <div>
          ...
          <a href="#" class="inline-flex items-center justify-center gap-2 bg-primary px-7 py-2 text-base text-white transition-all hover:bg-primary-700">Read More
            <i data-lucide="move-right" class="size-6"></i>
          </a>

          <div class="mt-10 grid grid-cols-3 gap-6">
            <img src="assets/images/landing/photography/img-13.jpg" alt="" />
            <img src="assets/images/landing/photography/img-7.jpg" alt="" />
            <img src="assets/images/landing/photography/img-14.jpg" alt="" />
          </div>
          <!-- grid End -->
        </div>
        <!-- col End -->
    ...
    <div class="container">
      <div class="mb-10 flex items-end justify-between">
        <div class="mx-auto max-w-2xl text-center">
          <span class="border border-default-200 px-3 py-1 text-xs font-medium uppercase tracking-wider text-default-950">Our Services</span>
      ...
      <div class="grid gap-6 xl:grid-cols-2">
        <div class="border border-default-100 bg-default-50 p-6">
          <div class="flex flex-wrap gap-6 md:flex-nowrap">
            <div>
              <div class="flex size-14 items-center justify-center border border-primary/10 bg-primary/5">
        ...
        <div class="border border-default-100 bg-default-50 p-6">
          <div class="flex flex-wrap gap-6 md:flex-nowrap">
            <div>
              <div class="flex size-14 items-center justify-center border border-primary/10 bg-primary/5">
                <i data-lucide="user-square" class="size-10 text-primary"></i>
              </div>
            </div>
            <div>
  ...
  <section id="portfolio" class="py-10 lg:py-20">
    <div class="container">
      <div class="flex flex-wrap items-center justify-between gap-5">
        ...
        <div>
          <a href="#" class="inline-flex items-center justify-center gap-2 border border-default-200 bg-primary px-6 py-2 text-white transition-all duration-300 hover:bg-primary-700">View All</a>
        </div>
      </div>
      <!-- flex End -->
    </div>
    ...
    <div class="mt-14">
      <div class="relative m-auto flex gap-8 overflow-hidden">
        <div class="marquee__group flex min-w-full flex-shrink-0 items-center justify-around gap-8">
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-3.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-2.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-6.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-10.jpg" alt="" />
        </div>
        <!-- marquee__group End -->

        <div aria-hidden="true" class="marquee__group flex min-w-full flex-shrink-0 items-center justify-around gap-8">
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-9.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-2.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-5.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-10.jpg" alt="" />
        </div>
        <!-- marquee__group End -->
      </div>
      ...
      <div class="marquee--reverse m-auto mt-8 flex gap-8 overflow-hidden">
        <div class="marquee__group flex min-w-full flex-shrink-0 items-center justify-around gap-8 delay-[31s]">
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-3.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-2.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-6.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-10.jpg" alt="" />
        ...
        <div aria-hidden="true" class="marquee__group flex min-w-full flex-shrink-0 items-center justify-around gap-8 delay-[31s]">
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-9.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-2.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-5.jpg" alt="" />
          <img class="h-72 w-full object-cover" src="assets/images/landing/photography/img-10.jpg" alt="" />
    ...
    <div class="mt-12 flex items-center justify-center">
      <a href="#" class="inline-flex items-center justify-center gap-2 rounded border border-default-200 px-6 py-2 text-base font-medium text-default-950 transition-all duration-300 hover:bg-primary hover:text-default-950">View More
  ...
  <section id="faq" class="py-10 lg:py-20">
    <div class="container">
      <div class="mb-10 flex items-end justify-between">
        <div class="mx-auto max-w-2xl text-center">
          <span class="border border-default-200 px-3 py-1 text-xs font-medium uppercase tracking-wider text-default-950">Our FAQ</span>
      ...
      <div class="mx-auto max-w-3xl">
        <div class="hs-accordion-group space-y-4">
          <div class="hs-accordion active overflow-hidden border border-primary/20 hs-accordion-active:bg-primary/10" id="faq-1">
          ...
          <div class="hs-accordion overflow-hidden border border-primary/20 hs-accordion-active:bg-primary/10" id="faq-2">
          ...
          <div class="hs-accordion overflow-hidden border border-primary/20 hs-accordion-active:bg-primary/10" id="faq-3">
    ...
    <div class="container">
      ...
      <div class="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
        <div class="overflow-hidden border border-default-200">
          <a href="#" class="group relative overflow-hidden">
            <div class="overflow-hidden">
              <img src="assets/images/landing/photography/img-2.jpg" class="h-full w-full scale-[1.2] transition-all duration-700 group-hover:scale-[1]" alt="" />
            </div>
            <div class="p-6">
              <p class="text-lg text-primary">
                Strategies
                <span class="ms-4 text-sm font-medium text-default-950">5-minute Read</span>
              </p>
        ...
        <div class="overflow-hidden border border-default-200">
          <a href="#" class="group relative overflow-hidden">
            <div class="overflow-hidden">
              <img src="assets/images/landing/photography/img-12.jpg" class="h-full w-full scale-[1.2] transition-all duration-700 group-hover:scale-[1]" alt="" />
            </div>
            <div class="p-6">
              <p class="text-lg text-primary">
                Video
        ...
        <div class="overflow-hidden border border-default-200">
          <a href="#" class="group relative overflow-hidden">
            <div class="overflow-hidden">
              <img src="assets/images/landing/photography/img-10.jpg" class="h-full w-full scale-[1.2] transition-all duration-700 group-hover:scale-[1]" alt="" />
            </div>
            <div class="p-6">
              <p class="text-lg text-primary">
                Photography
      ...
      <div class="border border-primary/10 bg-primary/5 p-14">
        <div class="grid items-center gap-6 lg:grid-cols-2">
          <div>
            ...
            <a href="#" class="inline-flex items-center justify-center gap-2 bg-primary px-8 py-2 text-base text-white transition-all hover:bg-primary-700">Contact us
              <i data-lucide="move-right" class="size-6"></i>
            </a>
          </div>
          <!-- col End-->
          ...
          <div>
            <img src="assets/images/landing/photography/img-11.jpg" class="mx-auto" alt="" />
          </div>
          <!-- col End-->
        </div>
        <!-- grid End-->
