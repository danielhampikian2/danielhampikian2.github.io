            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="group relative overflow-hidden rounded-3xl">
                        <img
                                src="assets/images/landing/agency/img-6.jpg"
                                class="h-full w-full"
                                alt=""
                        />
                ...
                <div class="swiper-slide">
                    <div class="group relative overflow-hidden rounded-3xl">
                        <img
                                src="assets/images/landing/agency/img-7.jpg"
                                class="h-full w-full"
                                alt=""
                        />
                        <div class="absolute inset-0 bg-black/60"></div>
                ...
                <div class="swiper-slide">
                    <div class="group relative overflow-hidden rounded-3xl">
                        <img
                                src="assets/images/landing/agency/img-8.jpg"
                                class="h-full w-full"
                                alt=""
                        />
                        <div class="absolute inset-0 bg-black/60"></div>
                ...
                <div class="swiper-slide">
                    <div class="group relative overflow-hidden rounded-3xl">
                        <img
                                src="assets/images/landing/agency/img-9.jpg"
                                class="h-full w-full"
                                alt=""
                        />
                        <div class="absolute inset-0 bg-black/60"></div>
    ...
    <div class="container">
        ...
        <div class="relative">
            <div class="hidden lg:block">
                <div
                        class="before:absolute before:-start-10 before:-top-10 before:-z-10 before:h-24 before:w-24 before:rotate-180 before:bg-[url('../images/landing/agency/dot.svg')] after:absolute after:-bottom-10 after:-end-10 after:-z-10 after:h-24 after:w-24 after:bg-[url('../images/landing/agency/dot.svg')]"
                ></div>
            </div>
            ...
            >
                ...
                <div>
                    <div class="relative -z-10">
                        <img
                                src="assets/images/landing/agency/img-11.jpg"
                    ...
                    <div class="-mt-28 hidden text-end xl:block">
                        ...
                        >
                            <img
                                    src="assets/images/landing/agency/img-12.jpg"
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
            <div class="overflow-hidden rounded-lg border border-default-200">
                <div class="group p-6">
                    <div class="relative overflow-hidden rounded-md">
                        <img
                                src="assets/images/landing/agency/img-13.jpg"
                                class="rounded-md"
                                alt=""
                        />
            ...
            <div class="overflow-hidden rounded-lg border border-default-200">
                <div class="group p-6">
                    <div class="relative overflow-hidden rounded-md">
                        <img
                                src="assets/images/landing/agency/img-14.jpg"
                                class="rounded-md"
                                alt=""
                        />
                        <div class="absolute inset-0 bg-black/40"></div>
            ...
            <div class="overflow-hidden rounded-lg border border-default-200">
                <div class="group p-6">
                    <div class="relative overflow-hidden rounded-md">
                        <img
                                src="assets/images/landing/agency/img-15.jpg"
                                class="rounded-md"
                                alt=""
                        />
                        <div class="absolute inset-0 bg-black/40"></div>
