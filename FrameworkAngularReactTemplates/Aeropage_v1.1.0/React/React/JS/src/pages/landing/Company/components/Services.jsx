          ...
          <div className="grid 2xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
            {services.map((service, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-default-100 text-center rounded-lg dark:bg-default-50"
                >
                  <div className="p-6">
                    <div className="flex justify-center">
                      <Icon className="h-12 w-12 text-default-950" />
                    </div>
                    <h3 className="md:text-2xl text-xl font-medium text-default-950 mb-4 mt-6">
                      {service.title}
                    </h3>
