            ...
            {faqContent.map((faq, idx) => {
              return (
                <div key={idx} className="relative w-full lg:w-full z-20">
                  <div
                    className={cn(
                      "hs-accordion border border-default-200 hs-accordion-active:translate-x-2 hs-accordion-active:-translate-y-2 transition-all duration-500 bg-white overflow-hidden dark:bg-default-50",
                      { active: idx == 0 }
                    )}
                    id="faq-1"
                  >
