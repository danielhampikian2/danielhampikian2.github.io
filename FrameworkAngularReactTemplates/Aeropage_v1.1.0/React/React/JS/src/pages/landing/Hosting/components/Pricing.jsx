                  ...
                  <div className="p-6 bg-white dark:bg-default-50">
                    <div className="grid md:grid-cols-3 gap-6">
                      <div className="md:col-span-2">
                        ...
                        <p className="text-xs uppercase tracking-widest text-default-950 mt-2">
                          For Businesses and large organisations.
                        </p>
                        <p className="w-3/4 text-base/7 font-medium py-5 text-default-600">
                        ...
                        <div className="flex items-center">
                          <Link
                            to=""
                            className="inline-flex items-center text-default-900 text-lg font-semibold group"
                          >
                            Learn more
