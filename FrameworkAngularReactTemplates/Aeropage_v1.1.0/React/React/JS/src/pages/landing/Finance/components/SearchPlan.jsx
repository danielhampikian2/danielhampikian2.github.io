      ...
      <div className="container">
        <div className="rounded-lg shadow bg-cover bg-gradient-to-l from-primary/5 to-primary/10 via-primary/0">
          <div
            ...
            style={{ backgroundImage: `url(${backgroundLine2})` }}
          >
              ...
              <form className="max-w-2xl mx-auto space-y-2 mt-6">
                <div className="relative">
                  <input
                    type="email"
                    id="subcribe"
                    className="py-4 ps-4 pe-14 w-full h-12 rounded-md bg-default-50 text-default-950 border-default-200 focus:ring-0 focus:border-default-200"
