...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="py-40 relative overflow-hidden flex items-center justify-center bg-cover bg-no-repeat"
      style={{
        backgroundImage: `url(${
          themeMode == "light" ? backgroundImg : backgroundDarkImg
        })`,
      }}
    >
        ...
        <div className="relative">
          <div className="grid lg:grid-cols-2 gap-6 items-center">
            <div className="max-w-md mx-auto text-center lg:ms-0 lg:text-start">
              <span className="py-1 px-3 rounded-md text-xs font-medium uppercase tracking-wider border border-default-300 text-default-900">
                startups Marketing
              </span>
              <h2 className="md:text-5xl/tight text-4xl font-medium text-default-900 my-5">
              ...
              <Link
                to=""
                className="inline-flex items-center justify-center gap-2 border border-primary text-white py-2 px-6 rounded-md bg-primary/90 hover:text-default-950 hover:bg-primary transition-all duration-300 mt-6"
              >
                Get Solution
