      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-x-16 gap-y-10">
          ...
          <div>
            ...
            <Link
              to=""
              className="inline-flex justify-center gap-2 border border-default-200 text-default-950 py-2 px-6 rounded-md hover:bg-primary hover:text-white transition-all duration-500"
            >
              View All Our News
