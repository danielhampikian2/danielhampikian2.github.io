      ...
      <div className="container">
        <div className="flex items-end justify-between mb-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-default-800 font-medium mt-5">
          ...
          <div className="lg:-ms-20">
            <div className="divide-y divide-default-200 bg-default-50 rounded-md shadow">
              <div className="p-6 flex flex-wrap sm:flex-nowrap items-center gap-6">
                <div>
                  <div className="h-12 w-12 rounded-md flex items-center justify-center  text-xl border border-default-200 text-default-950 bg-white/5">
                    01
                  </div>
                </div>
                <div>
