            ...
            <div className="grid sm:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="grid grid-cols-1 gap-6 mt-10">
                    {investmentSteps.map((step, idx) => {
                      ...
                      return (
                        <div
                          key={idx}
                          className="p-6 rounded-md bg-white/60 dark:bg-black/60 backdrop-blur-xl"
                        >
                          <div className="flex flex-wrap md:flex-nowrap items-center gap-6">
                            ...
                            <div>
                              ...
                              <p className="text-base text-default-950 mt-3">
                                {step.description}
                              </p>
                            </div>
                          </div>
              ...
              <div className="relative h-full">
                <div className="flex items-center justify-center h-full">
                  <button
                    className="relative h-20 w-20 flex items-center justify-center gap-2.5 rounded-full text-base font-medium bg-primary text-white transition-all duration-300 ring-4 ring-primary/25 hover:bg-primary"
