...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative overflow-hidden lg:py-40 py-24 bg-primary/5"
    >
          ...
          <div className="max-w-xl">
            <div className="inline-block pe-5 rounded-full border border-primary/20">
              <div className="flex items-center gap-2">
                ...
                <span className="md:text-sm text-xs font-medium text-default-950">
                  Startup Business
                </span>
              </div>
            </div>
            <h1 className="md:text-4xl/tight text-4xl font-medium text-default-950 max-w-lg my-4">
            ...
            <div className="inline-block">
              <Link
                to=""
                className="flex items-center justify-center gap-2 py-2 px-6 mt-6 rounded-md text-base font-medium text-white bg-primary transition-all duration-500 hover:bg-primary-300"
              >
                Get started now
              </Link>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {features.map((feature, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-6 rounded-xl sm:text-start text-center border border-primary/20 bg-primary/5"
              >
