...
const Hero = () => {
  return (
    <section
      id="home"
      className="py-[164px] relative overflow-hidden flex items-center justify-center"
    >
        ...
        <div className="relative">
          <div className="grid lg:grid-cols-2 gap-6 items-center">
            <div className="max-w-md mx-auto text-center lg:ms-0 lg:text-start">
              ...
              <Link
                to=""
                className="px-6 py-3 rounded-md text-white bg-primary hover:bg-primary-700 transition-all duration-300"
              >
                Reach Out to Us
              </Link>
            </div>
