        ...
        <nav className="container flex w-full items-center justify-between gap-6">
          <div>
            <Link to="/" className="block">
              <img src={logoLight} className="flex h-8" alt="images" />
            </Link>
          </div>
          <div className="flex items-center gap-3">
            <div className="relative hidden lg:block">
              <LuSearch className="absolute start-3 top-1/2 size-4 -translate-y-1/2 text-zinc-400" />
              <input type="search" className="h-10 w-full rounded-full border-0 bg-zinc-800 pe-4 ps-11 text-zinc-300 placeholder-zinc-400 focus:ring-0 sm:text-sm" placeholder="Search..." />
            </div>
