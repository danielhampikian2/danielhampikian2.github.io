    ...
    <>
      ...
      <form onSubmit={handleSubmit(() => { })} className="mt-10 shrink">
        ...
        <div className="mb-6 flex flex-col justify-center gap-4">
          <button type="submit" className="relative inline-flex w-full items-center justify-center rounded bg-primary px-6 py-3 text-base capitalize text-white transition-all hover:bg-primary-700">Reset Password</button>
        </div>
      </form>
      <ThirdPartyAuth />
      <p className="shrink text-center text-zinc-200">
        Back To ?<Link to="/auth/sign-in" className="ms-1 text-primary"><b>Login</b></Link>
      </p>
