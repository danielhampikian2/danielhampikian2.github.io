      ...
      <div className="container">
        <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
          <div className="me-0 lg:mx-auto">
            <span className="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Testimonials</span>
            ...
            <div className="mt-10 flex items-center gap-10">
              <div className="text-center">
                <h2 className="text-4xl font-medium text-default-950">5,000+</h2>
                    ...
                    <SwiperSlide key={idx}>
                      <div className="rounded-xl border border-default-200 p-6">
                        <div className="flex items-center gap-6">
                          <div>
                            <img src={slide.image} className="h-16 rounded-full" />
                          </div>
                          <div>
                        ...
                        <div className="mt-5 flex items-center gap-2">
                          {Array.from(new Array(4)).map((_val, idx) => {
                            return (
                              <LuStar key={idx} className="size-5 fill-yellow-300 text-yellow-300" />
                            )
                          })}
