      ...
      <div className="container">
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-3xl text-center">
            <span className="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Showcase of Work</span>
        ...
        <div className="space-y-6">
          <div className="grid gap-6 md:grid-cols-3">
            <GlightBox data-glightbox data-gallery="gallery" href={startup5} className="glightbox block overflow-hidden rounded-lg h-full">
              <div className="group relative h-full w-full">
                <img src={startup5} className="h-full w-full" />
            ...
            <div className="md:col-span-2">
              <GlightBox data-glightbox data-gallery="gallery" href={startup6} className="glightbox block overflow-hidden rounded-lg">
                <div className="group relative">
                  <img src={startup6} className="h-full w-full" />
                  <div className="absolute inset-0 bg-black/40" />
                  <div className="absolute inset-x-0 bottom-0 top-auto m-2 opacity-0 transition-all duration-700 group-hover:opacity-100">
                    <div className="flex justify-center">
                      <div className="shadows w-full rounded-md bg-white py-3 text-center text-default-950 dark:bg-default-50">
                        <h2 className="text-2xl font-medium">Visual Stranger</h2>
          ...
          <div className='grid md:grid-cols-3 gap-6'>
            <GlightBox data-glightbox data-gallery="gallery" href={startup2} className="glightbox block overflow-hidden rounded-lg">
              <div className="group relative">
                <img src={startup2} className="h-full w-full" />
                <div className="absolute inset-0 bg-black/40" />
                <div className="absolute inset-x-0 bottom-0 top-auto m-2 opacity-0 transition-all duration-700 group-hover:opacity-100">
                  <div className="flex justify-center">
                    <div className="shadows w-full rounded-md bg-white py-3 text-center text-default-950 dark:bg-default-50">
            ...
            <GlightBox data-glightbox data-gallery="gallery" href={startup1} className="glightbox block overflow-hidden rounded-lg">
              <div className="group relative">
                <img src={startup1} className="h-full w-full" />
                <div className="absolute inset-0 bg-black/40" />
                <div className="absolute inset-x-0 bottom-0 top-auto m-2 opacity-0 transition-all duration-700 group-hover:opacity-100">
                  <div className="flex justify-center">
                    <div className="shadows w-full rounded-md bg-white py-3 text-center text-default-950 dark:bg-default-50">
            ...
            <GlightBox data-glightbox data-gallery="gallery" href={startup7} className="glightbox block overflow-hidden rounded-lg">
              <div className="group relative">
                <img src={startup7} className="h-full w-full" />
                <div className="absolute inset-0 bg-black/40" />
                <div className="absolute inset-x-0 bottom-0 top-auto m-2 opacity-0 transition-all duration-700 group-hover:opacity-100">
                  <div className="flex justify-center">
                    <div className="shadows w-full rounded-md bg-white py-3 text-center text-default-950 dark:bg-default-50">
