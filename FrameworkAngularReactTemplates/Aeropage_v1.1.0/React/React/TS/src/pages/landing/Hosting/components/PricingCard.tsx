      ...
      <div className="group">
        <div className="border border-default-200 w-full group-hover:translate-x-2 group-hover:-translate-y-2 transition-all duration-500">
          <div className="p-6 bg-white dark:bg-default-50">
            <h5 className="text-2xl font-medium text-center text-default-950">{name}</h5>
            <p className="text-xs uppercase tracking-widest text-center text-default-950 mt-1">For individuals and teams</p>
            <div className="flex items-center gap-4 bg-default-100 text-default-950 p-5 mt-6">
              <h2 className="text-5xl font-semibold"><sup className="text-xl">$</sup>{price}</h2>
              <div>
              ...
              {features.map((feature, idx) => {
                return (
                  <li key={idx} className="flex items-center gap-2">
                    ...
                    <span className="text-default-950 text-base">{feature}</span>
                  </li>
                )
              })}
            </ul>
