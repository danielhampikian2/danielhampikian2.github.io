    ...
    <section id="about" className="py-10 lg:py-20">
      <div className="container">
        <div className="grid items-center gap-6 lg:grid-cols-2">
          <div>
            <img src={web8} className="rounded-xl" />
          </div>
          <div className="p-6">
            <span className="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Our About</span>
            ...
            <div className="my-5 grid grid-cols-1">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xl text-default-950">Business Consultancy</h3>
              </div>
              <div className="flex items-center gap-2">
                <div>
                  <LuDot className="size-9 text-primary" />
            ...
            <Link to="" className="inline-flex items-center justify-center gap-2 rounded-md border border-default-200 px-8 py-2 text-default-950 backdrop-blur-3xl transition-all hover:border-primary hover:bg-primary hover:text-white">Read More
