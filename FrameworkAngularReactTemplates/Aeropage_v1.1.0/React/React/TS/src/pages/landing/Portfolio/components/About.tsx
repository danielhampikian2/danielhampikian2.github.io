...
const about = ["Boot Your Business", "Marketing Support", "Talented Teams", "24/7 Strong Support"]
const About = () => {
  return (
        ...
        <div className="grid items-center gap-6 2xl:grid-cols-2">
          <div className="flex justify-center">
            <div className="inline-block rounded-xl border border-primary/20 bg-primary/10 p-6">
              <img src={portfolio6} className="rounded-lg" />
            </div>
          </div>
          <div>
            <span className="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Our About
            </span>
              ...
              <div className="rounded-xl border border-default-200 bg-white p-6 dark:bg-default-50">
                <div className="grid md:grid-cols-3">
                  <div className="text-center">
                    <h2 className="text-4xl font-medium text-default-950">247+</h2>
                    <p className="mt-1 text-lg">Completed Projects</p>
                  </div>
                  <div className="border-default-200 text-center md:border-x">
                    <h2 className="text-4xl font-medium text-default-950">54+</h2>
                    <p className="mt-1 text-lg">Satisfied Customers</p>
                  </div>
                  <div className="text-center">
                    <h2 className="text-4xl font-medium text-default-950">43+</h2>
