...
import type { BlogType, FaqType, PortfolioSlideType, ServiceType, SlideType } from "./types"
...
const faqContents: FaqType[] = [
  {
    ...
    description: "Web design is the process of creating the visual and functional elements of a website.",
  },
  {
    title: "Are These Projects Real Or Concepts?",
    description: "The projects featured in my portfolio are a mix of real-world projects I've completed and conceptual designs that showcase my creative thinking and design skills.",
  },
  {
    title: "How Often Is The Portfolio Updated?",
    description: "I strive to keep my portfolio up-to-date with my latest work and projects. I regularly update it to reflect my evolving skills and design philosophy.",
  },
  {
    title: "Can I Leave Feedback Or Comments On The Portfolio Projects?",
    description: "At the moment, I don't have a comments section on the portfolio pages. However, I welcome feedback and inquiries.",
  },
]
...
const blogs: BlogType[] = [
  {
    ...
    description: "Lorem ipsum dolor sit amet, proin gravida nibh vel velit auctor aliquet. Aenean sollictudin, lorem quis bibendum auctor...",
    no: "06",
    image: agency13,
  },
  {
