...
const photographyImages = [photography1, photography2, photography3, photography4, photography5, photography6]
const Home = () => {
  return (
        ...
        <div className="container">
          <div className="p-6">
            <div className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div>
                <span className="bg-primary/10 px-3 py-1 text-sm font-medium uppercase tracking-wider text-primary shadow">Animals Frame</span>
                ...
                <Link to="" className="group mt-10 inline-flex items-center justify-center gap-2 rounded-full border border-default-200 px-1 py-1 pe-4 text-default-950 transition-all duration-300 hover:bg-primary-600 hover:text-white">
                  ...
                  <div className="relative m-auto flex flex-col gap-6 overflow-hidden">
                    <div className="marquee-hero flex min-h-full flex-shrink-0 flex-col items-center justify-around gap-6">
                      {photographyImages.map((image, idx) => (
                        <img key={idx} className="aspect-1 h-full w-60 object-cover" src={image} />
                      ))}
                    </div>
