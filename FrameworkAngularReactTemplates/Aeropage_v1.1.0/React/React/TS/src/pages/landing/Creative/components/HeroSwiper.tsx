...
const HeroSwiper = () => {
  ...
  return (
    <section id="home" className="bg-cover bg-no-repeat bg-[url('../images/other/bg-lines-2.png')] dark:bg-[url('../images/other/bg-lines-2-dark.png')]">
              ...
              return (
                <SwiperSlide key={idx}>
                  <div className="flex-col flex items-start justify-end xl:h-full pb-28">
                    <h2 className="text-4xl font-semibold text-default-950 mt-6 max-w-2xl">{slide.title}</h2>
                    <p className="w-3/4 text-base  font-medium mt-5">{slide.description}</p>
                  </div>
                </SwiperSlide>
              )
            })}
