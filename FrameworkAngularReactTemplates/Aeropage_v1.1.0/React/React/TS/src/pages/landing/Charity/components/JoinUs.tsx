      ...
      <section id="join" className="py-10 lg:py-20">
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            <span className="py-1 px-3 rounded-md text-xs font-medium uppercase tracking-wider border border-primary bg-primary/20 text-primary">Starting with a Child</span>
            <h2 className="text-3xl/snug font-medium text-default-950 mt-4">Starting with a Child </h2>
            <p className="text-base mt-5">Children growing up in poverty encounter significant challenges education and healthcare, social discrimination, and isolation.</p>
          </div>
          <div className="mt-10">
            <div className="grid grid-cols-3 gap-6">
                ...
                <div className="relative h-full group">
                  ...
                  <div className="opacity-0 group-hover:opacity-100 transition-all duration-700">
                    <div className="absolute inset-0 rounded-xl bg-black/50 flex items-center justify-center h-full">
                      <button className="relative h-20 w-20 flex items-center justify-center gap-2.5 rounded-full text-base font-medium bg-primary text-default-950 transition-all duration-300 ring-4 ring-primary/25 hover:bg-primary" data-hs-overlay="#watchvideomodal">
              ...
              <div className="space-y-5">
                <div className="relative group">
                  ...
                  <div className="opacity-0 group-hover:opacity-100 transition-all duration-700">
                    <div className="absolute inset-0 rounded-xl bg-black/50 flex items-center justify-center h-full">
                      <button className="relative h-14 w-14 flex items-center justify-center gap-2.5 rounded-full text-base font-medium bg-primary text-default-950 transition-all duration-300 ring-4 ring-primary/25 hover:bg-primary" data-hs-overlay="#watchvideomodal">
