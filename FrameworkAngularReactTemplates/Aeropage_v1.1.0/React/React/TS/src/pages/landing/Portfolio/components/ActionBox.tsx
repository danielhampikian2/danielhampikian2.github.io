          ...
          <div className="px-6 py-20">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="inline-block">
                <Link to="" className="mt-6 flex items-center justify-center gap-2 rounded-md border border-primary bg-primary/90 px-6 py-2 text-white transition-all hover:bg-primary">Get started <LuMoveRight  className="h-5 w-5" /></Link>
              </div>
            </div>
          </div>
        </div>
