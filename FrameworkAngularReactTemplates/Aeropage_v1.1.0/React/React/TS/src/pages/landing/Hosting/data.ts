import { LuBringToFront, LuCheck, LuFile, LuFolderDown, LuLayers, LuNavigation, LuShield, LuTable2 } from "react-icons/lu";
import { FaqType, PricingPlan, ServiceType, TestimonialSliderType } from "./types";
...
const pricingPlans: PricingPlan[] = [
  {
    ...
    price: 8,
    features: ["Unlimited Email", "Unlimited Updates", "Free 5 host & domain", "24/7 Dedicated Support", "Backing", "Up to 10 users monthly"],
  },
  {
    name: "Wordpress",
    ...
    price: 12,
    features: ["Unlimited Email", "Unlimited Updates", "Free 5 host & domain", "24/7 Dedicated Support", "Backing", "Up to 30 users monthly"],
  },
  {
    name: "VPS",
    ...
    price: 37,
    features: ["Unlimited Email", "Unlimited Updates", "Free 5 host & domain", "24/7 Dedicated Support", "Backing", "Up to 80 users monthly"],
  },
]
...
const services: ServiceType[] = [
  {
    ...
    description: "Initiate a Support Request for Prompt Assistance and Timely Resolution.",
    icon: LuFile,
  },
  {
    title: "Choose Site Transfer",
    description: "Streamline the migration process with added security measures.",
    icon: LuLayers,
  },
  {
    title: "Completion",
  ...
  },
  {
    ...
    description: "Streamline the connection of your site to your domain name with Vault.",
    icon: LuNavigation,
  },
  {
    title: "20/8 network security",
    description: "Enjoy peace of mind with constant network security for your visitors.",
    icon: LuLayers,
  },
  {
    title: "User-friendly control panel",
    description: "Effortlessly manage app installations and backups with the industry-standard cPanel.",
    icon: LuShield,
  },
  {
  ...
  },
  {
    ...
    description: "Enhance page loading speed and improve the customer experience with Vault hosting.",
    icon: LuFolderDown,
  },
  {
...
const faqContent: FaqType[] = [
  {
    ...
    description: "I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.",
  },
  {
  ...
  },
  {
    ...
    description: "Absolutely! We offer content creation services, including blog posts, social media content, and multimedia assets.",
  },
  {
