    ...
    <section id="contact" className="py-20">
      <div className="container">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          <span className="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Our Contact Us</span>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-md border border-default-300 bg-white p-8 dark:bg-default-50">
            <form onSubmit={handleSubmit(() => { })} className="relative">
              ...
              <button type="submit" className="flex items-center rounded-md bg-primary/90 px-6 py-2 text-white transition-all hover:bg-primary">
                Send Messages
