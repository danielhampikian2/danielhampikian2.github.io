...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative flex items-center justify-center overflow-hidden  bg-cover bg-no-repeat py-28" style={{ backgroundImage: `url(${themeMode == "light" ? web11 : web11Dark})` }}>
            ...
            <div className="mb-10">
              <div className="max-w-xl rounded-md bg-default-950/20 backdrop-blur-2xl">
                <form className="mt-6 flex w-full items-center justify-between">
                  <input type="email" name="email" id="email" className="w-full border-0 bg-transparent p-4 text-base text-default-950 placeholder:text-default-950 focus:outline-none focus:ring-0" placeholder="Enter Your Email" autoComplete="off" />
              ...
              <small className="mb-6 mt-2 text-sm">Don't miss out on your favourite username.</small>
            </div>
            <Link to="" className="inline-flex items-center justify-center gap-2 rounded-md bg-primary px-8 py-2 text-white backdrop-blur-3xl transition-all duration-300 hover:border-primary hover:bg-primary-700">Read More
