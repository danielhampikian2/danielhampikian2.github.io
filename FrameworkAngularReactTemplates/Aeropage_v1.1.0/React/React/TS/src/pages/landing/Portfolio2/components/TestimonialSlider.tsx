      ...
      <div className="container">
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            <span className="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Our Testimonials</span>
        ...
        <div className="rounded-xl bg-default-100 p-6">
          <div className="grid grid-cols-1 lg:grid-cols-5">
            <div className="col-span-2">
              <div>
                <img src={portfolio1} className="rounded-xl" />
              </div>
            </div>
                    ...
                    <SwiperSlide key={idx}>
                      <div className="pt-3">
                        <div className="flex items-center gap-5">
                          <img src={slide.image} className="size-16 rounded-full border-4 border-white/20" />
                          <div>
                        ...
                        <div className="mt-5 flex items-center gap-2">
                          {Array.from(new Array(5)).map((_val, idx) => {
                            return (
                              <LuStar key={idx} className="size-5 stroke-yellow-300" />
                            )
                          })}
                        </div>
                      </div>
