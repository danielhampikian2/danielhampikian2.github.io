        ...
        <div className="bg-default-100 rounded-lg dark:bg-default-50">
          <div className="md:p-20 p-10 bg-no-repeat bg-cover bg-[url('../images/other/bg-lines-2.png')] dark:bg-[url('../images/other/bg-lines-2-dark.png')]">
            <div className="max-w-2xl mx-auto text-center mb-12">
              <span className="py-1 px-3 rounded-md text-xs font-medium uppercase tracking-wider border border-primary bg-primary/20 text-primary">Our Testimonials</span>
              <h2 className="md:text-4xl text-3xl font-medium text-default-950 mt-3">Explore the feedback from our clients.</h2>
            </div>
                    ...
                    <SwiperSlide key={idx}>
                      <div className="max-w-4xl mx-auto text-center">
                        <div className="p-6">
                          ...
                          <p className="md:text-xl  mt-4 mb-6">"{slide.description}"</p>
