    ...
    <section className="bg-default-100 dark:bg-default-50">
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-6 items-center">
          <div>
            <h2 className="text-4xl/tight font-medium text-default-950">Elevate Your Life with Ebooks Authored by Experts</h2>
            <p className="text-base  mt-4">Aenean posuere, tortor sed cursus feugiat, nunc augue blandit nunc, eu sollicitudin and urna dolor sagittis lacus. Vestibulum fringilla pede sit amet augue.</p>
            <div className="backdrop-blur-2xl bg-white rounded-md max-w-xl mt-10 dark:bg-default-100">
              <form onSubmit={handleSubmit(() => { })}>
                <TextFormInput
                  ...
                  endButton={<button type="submit" className="inline-flex items-center justify-center absolute top-[6px] end-[6px]  py-2  px-6 me-2 border-0 text-white font-semibold text-base rounded-md backdrop-blur-2xl bg-primary hover:bg-primary-700 transition-all">
                    <span>Submit</span>
                  </button>}
                  control={control}
                  noValidate
                ...
                <div className="relative gap-6 m-auto flex flex-col overflow-hidden">
                  <div className="marquee-hero gap-6 flex flex-col items-center justify-around flex-shrink-0 h-full min-h-full">
                    {bookImages.map((image, idx) => (
                      <img key={idx} className="aspect-1 object-cover h-full w-60" src={image} />
                    ))}
                  </div>
