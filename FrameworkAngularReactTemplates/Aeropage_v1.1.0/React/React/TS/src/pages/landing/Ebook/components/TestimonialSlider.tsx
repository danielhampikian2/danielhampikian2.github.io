      ...
      <div className="container">
        <div className="flex items-end justify-between mb-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h2 className="text-4xl font-medium text-default-950 my-4">Success Stories</h2>
            <p className="text-base">Uncover a realm of opportunities within our extensive ebook collection.</p>
          </div>
        </div>
                    ...
                    <SwiperSlide key={idx} className="swiper-slide">
                      <div className="pt-3">
                        <div className="flex items-center gap-6">
                          <div>
                            <img src={slide.image} className="h-14 rounded-full" />
                          </div>
                          <div>
                            <h3 className="text-2xl font-medium text-default-950">{slide.name}</h3>
                        ...
                        <div className="flex items-center gap-2 mt-5">
                          {Array.from(new Array(5)).map((_val, idx) => {
                            return (
                              <LuStar key={idx} className="h-5 w-5 fill-yellow-400 stroke-yellow-400" />
                            )
                          })}
                        </div>
                      </div>
