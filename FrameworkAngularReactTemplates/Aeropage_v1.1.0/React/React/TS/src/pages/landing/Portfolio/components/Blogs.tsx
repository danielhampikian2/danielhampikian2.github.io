      ...
      <div className="container">
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            <span className="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Our Blog</span>
        ...
        <div className="grid gap-6 xl:grid-cols-2">
          <div className="rounded-xl border border-primary/20 bg-primary/10 p-6">
            <div className="relative h-full w-full">
              <img src={portfolio3} className="h-full w-full rounded-md" />
              <div className="absolute inset-x-0 bottom-0 top-auto hidden md:block">
                <div className="m-2 rounded-xl bg-black/10 p-2 backdrop-blur-md">
                  <div className="group text-center">
                    ...
                    <Link to="" className="text-lg font-medium text-white">Read More
