...
const Hero = () => {
  return (
    <>
      <section id="home" className="md:py-20 flex items-center justify-center relative overflow-hidden bg-cover bg-gradient-to-l from-primary/5 to-primary/10 via-primary/0">
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 2xl:gap-20">
            <div className="pt-[132px] pb-20">
              ...
              <div className="flex flex-wrap items-center mt-10 gap-6">
                <Link to="" className="inline-flex items-center justify-center gap-2 text-base py-3 px-10 rounded-full text-white bg-primary hover:bg-primary-700 transition-all duration-700">Get Started <LuMoveRight className="h-6 w-6" /></Link>
