    ...
    <section className="py-10 lg:py-20">
      <div className="container">
        <div className="max-w-xl mx-auto text-center mb-12">
          <h2 className="md:text-4xl text-3xl font-medium text-default-950">Didn't find the answer you were looking for?</h2>
        ...
        <div className="bg-default-100 dark:bg-default-50">
          <div className="md:p-20 p-10 text-center bg-no-repeat bg-cover" style={{ backgroundImage: `url(${themeMode == "light" ? bgLine : bgLineDark})` }}>
            <h2 className="md:text-4xl text-3xl font-medium text-default-950">Sign up today for top-notch web hosting services.</h2>
            <div className="flex flex-wrap items-center justify-center gap-6 mt-7">
              <Link to="" className="inline-flex gap-2 md:text-xl items-center relative text-default-950 hover:text-primary group">
