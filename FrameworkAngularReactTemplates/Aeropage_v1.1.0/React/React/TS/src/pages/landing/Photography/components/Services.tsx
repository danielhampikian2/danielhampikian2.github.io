      ...
      <div className="container">
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            <span className="border border-default-200 px-3 py-1 text-xs font-medium uppercase tracking-wider text-default-950">Our Services</span>
        ...
        <div className="grid gap-6 xl:grid-cols-2">
          {services.map((service, idx) => {
            ...
            return (
              <div key={idx} className="border border-default-100 bg-default-50 p-6">
                <div className="flex flex-wrap gap-6 md:flex-nowrap">
                  ...
                  <div>
                    <h2 className="text-5xl font-medium text-default-950">0{idx + 1}</h2>
