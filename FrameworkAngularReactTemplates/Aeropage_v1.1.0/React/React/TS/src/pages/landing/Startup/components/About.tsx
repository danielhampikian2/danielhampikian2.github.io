        ...
        <div className="grid grid-cols-1 items-center gap-6 xl:grid-cols-2">
          <div className="relative mb-20 lg:mb-0">
            <div className="relative">
              <img src={startup3} className="mx-auto rounded-xl" />
            </div>
            <div className="absolute inset-x-0 -bottom-14 hidden sm:block">
              <img src={startup10} className="h-full rounded-xl" />
            </div>
          </div>
          <div>
            <span className="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">About Our Studio</span>
            ...
            <ul role="list" className="mt-6 space-y-2">
              <li className="flex items-center gap-2">
                ...
                <span className="text-base">Lorem ipsum dolor sit amet, consectetur adipiscing.</span>
              </li>
              <li className="flex items-center gap-2">
                <LuMinus className="inline-block size-7 text-primary" />
                <span className="text-base">Vivamus hendrerit eros vitae tincidunt vulputate.</span>
              </li>
              <li className="flex items-center gap-2">
                <LuMinus className="inline-block size-7 text-primary" />
                <span className="text-base">Aenean at bibendum enim. In auctor consectetur urna.</span>
              </li>
              <li className="flex items-center gap-2">
                <LuMinus className="inline-block size-7 text-primary" />
                <span className="text-base">Proin ut gravida lorem, quis scelerisque metus.</span>
              </li>
            </ul>
            <div className="mt-10">
              <Link to="" className="inline-flex items-center justify-center gap-2 rounded-md border border-default-300 px-8 py-2 text-base text-default-900 transition-all hover:border-primary hover:bg-primary hover:text-white">Read More
