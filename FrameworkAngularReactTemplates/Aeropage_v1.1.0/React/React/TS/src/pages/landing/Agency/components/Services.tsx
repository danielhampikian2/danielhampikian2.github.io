      ...
      <div className="container">
        <div className="flex items-end justify-between mb-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h2 className="text-4xl font-medium capitalize text-default-950 my-4">Our Services</h2>
            <p className="text-base">Lorem ipsum dummy text are usually use print and website industry.</p>
          </div>
        </div>
            ...
            return (
              <div key={idx} className="group">
                <div className="sm:p-10 p-8">
                  ...
                  <h2 className="text-2xl text-default-950 font-medium mb-4 mt-8">{service.title}</h2>
