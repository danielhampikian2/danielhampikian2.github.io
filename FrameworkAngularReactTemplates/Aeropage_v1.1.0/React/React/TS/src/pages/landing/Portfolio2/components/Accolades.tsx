      ...
      <div className="container">
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            <span className="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Our Accolades</span>
              ...
              {accolades.slice(0, 3).map((item, idx) => {
                return (
                  <Link key={idx} to="" className="group">
                    <div className={cn("flex items-center justify-between p-5", item.divider ? "border-y border-default-200" : "")} >
                      <div>
