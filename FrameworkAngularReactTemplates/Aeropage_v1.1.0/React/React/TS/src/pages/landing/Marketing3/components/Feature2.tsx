import { LuActivitySquare, LuComponent, LuMoveRight, LuShoppingBag, LuToggleRight } from "react-icons/lu"
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-5">
              ...
              <div className="h-40 w-52 rounded-xl bg-sky-500/10 p-6 text-center md:-mt-14">
                ...
                <h3 className="mt-3 text-xl font-medium text-sky-600">Marketing</h3>
              </div>
            </div>
          </div>
          <div>
