      ...
      <div className="container">
        <div className="grid items-center gap-6 xl:grid-cols-5">
          <div className="xl:col-span-2">
            <div>
              <img src={avatar1} className="mx-auto h-80 rounded-full" />
            </div>
          </div>
          <div className="xl:col-span-3">
            ...
            <div className="inline-block">
              <Link to="" className="mt-6 flex items-center justify-center gap-2 rounded-md border border-primary bg-primary/90 px-6 py-2 text-lg text-white transition-all hover:bg-primary">Read more <LuMoveRight className="size-7" /></Link>
            </div>
          </div>
        </div>
      </div>
