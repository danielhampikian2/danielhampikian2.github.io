      ...
      <div className="container">
        <div className="relative overflow-hidden rounded-3xl bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_24px] dark:bg-default-50">
          <div className="grid items-center gap-6 lg:grid-cols-2">
            <img src={Marketing3} className="h-full w-full" />
            <div className="relative p-6">
              <span className="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Exploratory Studies</span>
              ...
              <div>
                ...
                <div className="mt-1 flex h-4 w-full overflow-hidden rounded-full bg-default-200">
                  <div className="flex flex-col justify-center overflow-hidden bg-primary" role="progressbar" style={{ width: '75%' }} aria-valuenow={46} aria-valuemin={0} aria-valuemax={100} />
                </div>
              </div>
              <div className="my-10">
                <div className="flex items-center justify-between gap-6">
                ...
                <div className="mt-1 flex h-4 w-full overflow-hidden rounded-full bg-default-200">
                  <div className="flex flex-col justify-center overflow-hidden bg-primary" role="progressbar" style={{ width: '95%' }} aria-valuenow={46} aria-valuemin={0} aria-valuemax={100} />
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between gap-6">
                ...
                <div className="mt-1 flex h-4 w-full overflow-hidden rounded-full bg-default-200">
                  <div className="flex flex-col justify-center overflow-hidden bg-primary" role="progressbar" style={{ width: '85%' }} aria-valuenow={46} aria-valuemin={0} aria-valuemax={100} />
                </div>
              </div>
            </div>
          </div>
