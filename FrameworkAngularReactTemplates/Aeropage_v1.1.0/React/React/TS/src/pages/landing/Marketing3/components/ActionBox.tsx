      ...
      <div className="container">
        <div className="rounded-xl bg-primary/20 p-6">
          <div className="grid items-center gap-6 md:grid-cols-3">
            <div>
              <img src={marketing7} className="max-w-full" />
            </div>
            <div className="md:col-span-2">
              <div className="flex flex-col">
                ...
                <div>
                  <Link to="" className="inline-flex items-center justify-center gap-2 rounded-md bg-primary px-6 py-2 text-white transition-all hover:bg-primary-700">Sign up free
