      ...
      <div className="container">
        <div className="grid lg:grid-cols-5 lg:gap-12 gap-8 items-center">
          ...
          <div className="lg:col-span-3 lg:order-2 order-1">
            <h2 className="text-4xl font-medium text-default-950">Our Featured Courses</h2>
            <p className="text-base font-me mt-4">Lorem ipsum dolor sit amet, consectetur, adipiscing elit. pellentesque quils arcu nisl. pellentesque quis arcu nisl. pellentesque ac tortor et est dignissim vulputate. proin quis sagittis est. phasellus dignissim dui et ipsum elementum, et auctor risus posuere.</p>
