import type { BlogType, FaqType, PricingType, ProjectSlideType, ReviewType } from "./types";
...
const pricingPlans: PricingType[] = [
  {
    ...
    day: 14,
    price: 24,
    features: ["Guaranteed quality control", "Top quality service", "Best experts at your lease"],
  },
  {
    name: "enterprise",
    day: 14,
...
const allReviews: ReviewType[] = [
  {
    name: "Leonard Heiser",
    description: "I have been hiring people in this space for and numbers of years and I have to be never seen this level of professionalism.",
    image: avatar1,
  },
  {
    name: "Leonard Heiser",
