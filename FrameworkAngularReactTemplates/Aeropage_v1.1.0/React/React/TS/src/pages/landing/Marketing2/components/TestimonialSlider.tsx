      ...
      <div className="container">
        <div className="flex items-end justify-between mb-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h2 className="text-3xl font-medium capitalize text-default-950 my-4">Client Success Stories</h2>
          </div>
        </div>
                    ...
                    <div className="sm:p-10 pb-10">
                      ...
                      <div className="flex items-center gap-2 mt-5">
                        {Array.from(new Array(5)).map((_val, idx) => {
                          return (
                            <LuStar key={idx} className="h-5 w-5 stroke-yellow-400 fill-yellow-400" />
                          )
                        })}
                      </div>
                    </div>
