        ...
        <div className="border border-primary/10 bg-primary/5 p-14">
          <div className="grid items-center gap-6 lg:grid-cols-2">
            <div>
              ...
              <Link to="" className="inline-flex items-center justify-center gap-2 bg-primary px-8 py-2 text-base text-white transition-all hover:bg-primary-700">Contact us
                <LuMoveRight className="h-6 w-6" />
              </Link>
            </div>
            <div>
              <img src={photography11} className="mx-auto" />
            </div>
          </div>
        </div>
      </div>
