      ...
      <div className="container">
        <div className="grid items-center gap-6 xl:grid-cols-5">
          <div className="xl:col-span-3">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              {services.map((service, idx) => {
                ...
                return (
                  <div key={idx} className={`${idx % 2 == 0 ? "xl:-mt-8" : ""}`}>
                    <div className="group relative cursor-pointer rounded-xl border border-default-200 p-6">
                      ...
                      <div className="mt-5">
                        <Link to="" className="text-lg font-medium text-default-900 after:absolute after:inset-0">Read More
          ...
          <div className="xl:col-span-2">
            ...
            <div className="mt-10">
              <Link to="" className="inline-flex items-center justify-center gap-2 rounded-md bg-primary px-8 py-2 text-base text-white transition-all hover:bg-primary-700">Read More
