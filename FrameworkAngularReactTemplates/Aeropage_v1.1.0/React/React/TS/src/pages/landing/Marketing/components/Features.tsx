      ...
      <div className="container">
        <div className="flex items-end justify-between mb-10">
          <div className="max-w-2xl mx-auto text-center">
            <span className="py-1 px-3 rounded-md text-xs font-medium uppercase tracking-wider border border-primary bg-primary/20 text-primary">Features</span>
              ...
              <div className="group">
                <div className="flex flex-wrap items-center gap-6 p-6">
                  ...
                  <div>
                    ...
                    <p className="text-base mb-6">Lorem ipsum dummy text are used in this design</p>
              ...
              <div className="group border-y border-default-200">
                <div className="flex flex-wrap items-center gap-6 p-6">
                  ...
                  <div>
                    ...
                    <p className="text-base mb-6">Nullam dictum felis eu pede mollis pretium.</p>
                    <Link to="" className="text-default-950 text-lg">Read More
                      <LuMoveRight className="group-hover:opacity-100 opacity-0 w-6 h-6 inline-block transition-all duration-500 group-hover:translate-x-2 will-change-transform" />
                    </Link>
                  </div>
              ...
              <div className="group">
                <div className="flex flex-wrap items-center gap-6 p-6">
                  ...
                  <div>
                    ...
                    <p className="text-base mb-6">Maecenas malesuada. Praesent congue erat at massa.</p>
                    <Link to="" className="text-default-950 text-lg">Read More
                      <LuMoveRight className="group-hover:opacity-100 opacity-0 w-6 h-6 inline-block transition-all duration-500 group-hover:translate-x-2 will-change-transform" />
                    </Link>
                  </div>
