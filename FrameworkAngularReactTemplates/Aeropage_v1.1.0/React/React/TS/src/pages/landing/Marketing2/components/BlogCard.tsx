    ...
    <div className="p-6 border border-default-200 rounded-lg overflow-hidden">
      <div className="relative group overflow-hidden">
        <div className="overflow-hidden rounded-md">
          <img src={image} className="h-full w-full scale-[1.2] group-hover:scale-[1] transition-all duration-700" />
        </div>
        ...
        <h2 className="text-xl font-medium text-default-950 mt-4 group-hover:underline transition-all duration-700">{title}</h2>
