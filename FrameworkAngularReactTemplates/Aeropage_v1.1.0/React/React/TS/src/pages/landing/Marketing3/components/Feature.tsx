      ...
      <div className="container">
        <div className="grid items-center gap-6 lg:grid-cols-2">
          <div>
            ...
            <ul role="list" className="mt-6 text-sm text-default-700">
              <li className="flex items-center gap-2">
                ...
                <span className="text-base font-medium">99.9% Uptime Assurance</span>
              </li>
              <li className="flex items-center gap-2">
                <LuDot className="inline-block h-9 w-9 text-primary" />
                <span className="text-base font-medium">Endless Photos and Videos</span>
              </li>
              <li className="flex items-center gap-2">
                <LuDot className="inline-block h-9 w-9 text-primary" />
          ...
          <div className="h-[500px]">
            <img src={marketing4} className="h-full w-full" />
          </div>
        </div>
      </div>
    </section>
