    ...
    <section className="py-20">
      <div className="mx-20">
        <div className=" mx-auto text-center mb-14">
          <span className="inline-flex text-base border-x-2 border-x-primary-600 text-primary-700 font-semibold px-2 rounded-lg bg-primary/20 mb-2">Demo</span>
          <h2 className="text-3xl font-semibold text-default-950 mb-2.5">Security</h2>
        ...
        <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-8 justify-content-center">
          ...
          {authDemos.slice(0, 3).map((demo, idx) => <PreviewCard demo={demo} key={idx} />)}
