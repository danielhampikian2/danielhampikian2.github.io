          ...
          <div className="flex flex-wrap gap-3">
            <div className="hs-tooltip inline-block [--placement:top] [--trigger:hover]">
              <Link className="hs-tooltip-toggle block text-center" to="">
                ...
                <div className="hs-tooltip-content relative z-50 hidden rounded bg-default-800 px-3 py-1 font-semibold text-default-200 opacity-0 transition-opacity hs-tooltip-shown:visible hs-tooltip-shown:opacity-100" role="tooltip">
                  Top Tooltip
