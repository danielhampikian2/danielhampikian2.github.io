        ...
        <ComponentContainerCard title="Popovers">
          <div className="flex flex-wrap gap-3">
            {placements.map((placement, idx) => {
              return (
                <div key={idx} className={`hs-tooltip inline-block [--placement:${placement}] [--trigger:click]`}>
                  <Link className="hs-tooltip-toggle block text-center" to="">
                    ...
                    <div className="hs-tooltip-content relative z-50 hidden w-60 rounded border bg-default-800 px-3 py-1 font-medium text-default-200 opacity-0 transition-opacity hs-tooltip-shown:visible hs-tooltip-shown:opacity-100" role="tooltip">
