            ...
            <div className="flex items-center justify-between p-6">
              ...
              <div className="flex items-center justify-end gap-3">
                <div className="flex items-center gap-2">
                  <Link to="" className="text-base font-medium text-default-900 transition-all duration-200 hover:text-primary">Admin</Link>
                </div>
                <div className="flex items-center gap-2">
                  <LuChevronsRight  className="size-5 text-default-900 rtl:rotate-180" />
                  <Link to="" className="text-base font-medium text-default-900">{title}</Link>
                </div>
              </div>
            </div>
          </div>
