      ...
      <div class="grid items-center gap-6 xl:grid-cols-5">
        ...
        <div class="xl:col-span-3">
          ...
          <h4 class="mt-5 text-xl font-medium text-default-400">
            Hello! I'm Diego, a self-taught and award-winning Digital Designer and Developer with
            more than fifteen years of professional experience. I began my journey in my childhood
            bedroom and honed my skills at renowned digital agencies like nexum AG.
          </h4>
