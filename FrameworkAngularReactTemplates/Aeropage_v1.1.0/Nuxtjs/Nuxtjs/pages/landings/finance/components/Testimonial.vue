      ...
      <div class="flex items-end justify-between mb-10">
        <div class="max-w-2xl mx-auto text-center">
          <span
            ...
            >Our Experts</span
          >
          <h2 class="text-4xl font-medium text-default-950 mt-4">
            You're the expert in business; we're the numbers experts.
          </h2>
        </div>
      </div>

      <div class="grid lg:grid-cols-2 gap-px overflow-hidden rounded-xl">
        <TestimonialCard5
          v-for="(testimonial, idx) in testimonialData.slice(0, 2)"
          :key="idx"
...
import TestimonialCard5 from '@/components/widgets/TestimonialCard5.vue'
