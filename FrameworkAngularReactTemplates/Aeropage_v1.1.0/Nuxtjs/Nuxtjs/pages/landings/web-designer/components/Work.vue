          ...
          <div class="filters-group-wrap text-center">
            <div class="filters-group">
              <div class="filter-options flex list-none flex-wrap justify-center gap-4">
                ...
                <router-link
                  to=""
                  :class="selectedCategory === 'web-design' ? 'active' : ''"
                  @click="filterImages('web-design')"
                  >Web Design
                </router-link>
                <router-link
                  to=""
                  :class="selectedCategory === 'graphic-design' ? 'active' : ''"
                  @click="filterImages('graphic-design')"
                  >Graphic Design
                </router-link>
                <router-link
                  to=""
                  :class="selectedCategory === 'illustrator' ? 'active' : ''"
                  @click="filterImages('illustrator')"
                  >Illustrator
                </router-link>
                <router-link
                  to=""
                  :class="selectedCategory === 'photography' ? 'active' : ''"
                  @click="filterImages('photography')"
                  >Photography
                </router-link>
              </div>
            </div>
