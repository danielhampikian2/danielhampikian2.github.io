    ...
    <div class="container">
      <div class="mx-auto mb-14 max-w-xl text-center">
        ...
        <p class="mt-5 text-base">
          Marketing encompasses the activities, institutions, and procedures aimed at generating,
          conveying, delivering, and exchanging valuable offerings for customers, partners, and
          society as a whole.
        </p>
      </div>
...
import type { AuthorType, TestimonialType } from '@/types/landing'
import TestimonialCard7 from '@/components/widgets/TestimonialCard7.vue'
