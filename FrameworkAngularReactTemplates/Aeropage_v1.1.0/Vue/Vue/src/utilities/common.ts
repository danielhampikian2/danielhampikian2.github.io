import type { ContactType, FaqType, ProjectType, ServiceType, AuthorType, TestimonialType, BrandType } from '@/types/landing'

import { ComponentIcon, LayersIcon, LayoutGridIcon, LineChartIcon, MailIcon, PhoneIcon, SaveIcon } from 'lucide-vue-next'
