<template>
  <header class="sticky top-0 z-50">
    <div class="z-50 flex w-full flex-wrap border-b border-default-200 bg-zinc-950 py-2.5 text-sm sm:flex-nowrap sm:justify-start sm:py-4">
      <nav class="container flex w-full items-center justify-between gap-6">
        <div>
          <router-link :to="{ name: 'landing' }" class="block">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="hidden sm:flex">
            <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
              ...
              >
                ...
                <span class="absolute -end-0 -top-0 h-4 w-4 rounded-full bg-primary text-xs font-medium text-white">2</span>
              </button>
              ...
              >
                <div class="flex items-center justify-between px-4 py-3">
                  ...
                  <a href="javascript: void(0);" class="border-b border-dashed border-default-300 font-semibold text-default-800">
                ...
                >
                  ...
                  >
                    <span
                      ...
                      :class="idx % 2 == 0 ? 'bg-primary/20 text-primary' : 'bg-teal-500/20 text-teal-500'"
                    >
                ...
                <a href="javascript:void(0);" class="block px-4 py-3 text-center text-sm font-medium text-primary"> View All </a>
              </div>
            </div>
          </div>
          ...
          <div class="flex">
            <div class="hs-dropdown relative inline-flex">
              ...
              >
                <img class="inline-block h-9 w-9 rounded-full" src="@/assets/images/avatars/img-1.jpg" />
              ...
              <div
                class="hs-dropdown-menu duration mt-2 hidden min-w-[12rem] rounded-lg border border-default-200 bg-white p-2 opacity-0 shadow-md transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50"
              >
                <a class="flex items-center gap-x-3.5 rounded-md px-3 py-2 text-sm text-default-800 transition-all hover:bg-default-100" href="#">
    ...
    <nav class="admin-menu border-b border-default-200 bg-white text-sm font-medium shadow-sm shadow-default-100 dark:bg-default-50">
      <div class="custom-scroll container mx-auto flex w-full snap-x items-center overflow-x-auto py-2.5">
        <div v-for="(item, idx) in adminNavbarLinkData" :key="item.name" class="shrink-0 snap-center px-2">
