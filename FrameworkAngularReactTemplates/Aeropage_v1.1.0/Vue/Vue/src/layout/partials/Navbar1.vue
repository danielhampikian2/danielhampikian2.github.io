        ...
        <ul class="menu lg:flex items-center justify-center hidden relative mx-auto grow">
          ...
          <li class="menu-item group">
            <div class="hs-dropdown relative inline-flex [--trigger:hover] [--placement:bottom]">
              ...
              >
                Landing <ChevronDownIcon class="w-4 h-4 ms-2"></ChevronDownIcon>
              </a>
      ...
      <nav class="hs-accordion-group p-4 w-full h-full flex flex-col flex-wrap">
        <ul class="space-y-1">
          ...
          <li class="hs-accordion" id="landing-accordion">
            ...
            >
              Landing
              <ChevronDownIcon class="w-5 h-5 ms-auto hs-accordion-active:rotate-180 transition-all"></ChevronDownIcon>
            </a>

            <div id="landing-accordion" class="hs-accordion-content w-full overflow-hidden transition-[height] hidden">
              <ul class="pt-2 ps-2">
                <li v-for="(item, idx) in navbarLinkData" :key="item.name">
                  <router-link
                    v-if="item.link"
...
import { type FunctionalComponent, onMounted } from 'vue'
