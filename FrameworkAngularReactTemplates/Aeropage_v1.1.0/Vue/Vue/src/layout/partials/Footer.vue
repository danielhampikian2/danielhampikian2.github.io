    ...
    <div class="py-4">
      <div class="container flex flex-wrap justify-center items-center h-full md:justify-between text-center md:text-start">
        <p class="text-base text-default-900">
          {{ year }}
          © AeroPage. Crafted and Coded with <span class="text-red-500">❤️</span> by
...
import { MoveRightIcon, FacebookIcon, InstagramIcon, TwitterIcon, LinkedinIcon } from 'lucide-vue-next'
