<template>
  <div class="fixed bottom-5 end-5 z-40 flex flex-col items-center gap-1">
    ...
    <button class="z-20 rounded-lg bg-primary text-white" @click="toggleTheme">
      <span v-if="useTheme.theme === 'light'" class="flex h-9 w-9 items-center justify-center" id="light-theme">
        <MoonIcon class="h-5 w-5" />
      </span>
      <span v-if="useTheme.theme === 'dark'" class="flex h-9 w-9 items-center justify-center" id="dark-theme">
