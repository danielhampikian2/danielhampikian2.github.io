...
import AdminPageTitle from '@/layout/partials/AdminPageTitle.vue'
...
import Source from '@/views/admin/dashboard/Source.vue'
import TopPerformer from '@/views/admin/dashboard/TopPerformer.vue'
import RecentOrder from '@/views/admin/dashboard/RecentOrder.vue'
