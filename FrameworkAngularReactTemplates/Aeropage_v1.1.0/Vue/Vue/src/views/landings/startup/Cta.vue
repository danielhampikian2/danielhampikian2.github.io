<template>
  <section class="pb-10 lg:pb-20">
    <div class="container">
      <div
        class="rounded-lg bg-default-100 bg-[url('../images/other/bg-lines-2.png')] bg-cover bg-no-repeat px-6 py-20 dark:bg-default-50 dark:bg-[url('../images/other/bg-lines-2-dark.png')]"
      >
        <div class="mx-auto max-w-2xl text-center">
          <span class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary"
            >Domain names</span
          >
          <h2 class="mt-5 text-3xl font-medium text-default-950 md:text-4xl">Stay up-to-date with our newsletter.</h2>
          ...
          <form class="mx-auto mt-6 max-w-2xl space-y-2">
            <div class="relative">
              ...
              <small>By submitting the form, you acknowledge and agree to our Terms & Conditions and Privacy Policy.</small>
            </div>
          </form>
        </div>
      </div>
