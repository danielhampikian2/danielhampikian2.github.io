  ...
  <section id="about" class="bg-white py-10 dark:bg-default-50 lg:py-20">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <div class="relative h-[650px]">
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" :style="{ backgroundImage: `url(${marketingImg5})` }">
        ...
        <div class="relative h-full">
          <div class="flex h-full items-center justify-center">
            ...
            >
              <PlayIcon class="h-7 w-7 fill-white" />
            </button>
          </div>
        </div>
      </div>
      ...
      <div class="py-10">
        <div class="max-w-lg px-10 md:ms-20">
          <span class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary"
            >About</span
          >
          <h2 class="mt-5 text-4xl font-medium text-default-950">Our mission is to bridge the gap between business and the digital world.</h2>
          <p class="mt-4 text-base">
            Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit
...
import marketingImg5 from '@/assets/images/landing/marketing/img-5.jpg'
import { PlayIcon, MoveRightIcon } from 'lucide-vue-next'
</script>
