    ...
    <div class="container">
      <div class="rounded-xl bg-primary/20 p-6">
        <div class="grid items-center gap-6 md:grid-cols-3">
          <div class="">
            <img :src="marketing3Img7" class="max-w-full" alt="" />
          </div>
            ...
            <div class="flex flex-col">
              <div class="">
                ...
                <p class="mb-6 text-sm">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. A tempora dolorem incidunt ex at possimus laborum nemo dolor. Nam
                  doloremque inventore dolor. Id maxime quos odio natus sit repellat fugiat.
                </p>
              </div>
              <div class="">
                <a
...
import marketing3Img7 from '@/assets/images/landing/marketing-3/img-7.png'
