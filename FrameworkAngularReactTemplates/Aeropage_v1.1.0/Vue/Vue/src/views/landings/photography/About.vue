  ...
  <section id="about" class="py-10 lg:py-20">
    <div class="container">
      <div class="grid grid-cols-1 items-end gap-6 lg:grid-cols-2">
        <div>
          <img :src="photography7" alt="" />
        </div>

        <div>
          <h2 class="text-4xl font-medium text-default-950">Revealing the Splendor of the Animal Realm</h2>
          <p class="mb-6 mt-4 text-base">
            Our profound affection and reverence for animals propel us forward. We firmly believe that every living being, regardless of its size,
            holds a unique tale, and our fervor lies in capturing their extraordinary moments through the lens of our cameras.
          </p>
          <a
            href="#"
          ...
          <div class="mt-10 grid grid-cols-3 gap-6">
            <img :src="photography13" alt="" />
            <img :src="photography7" alt="" />
            <img :src="photography14" alt="" />
          </div>
        </div>
      </div>
    </div>
