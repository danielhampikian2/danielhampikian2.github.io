    ...
    <div class="container">
      <div class="grid items-center gap-6 xl:grid-cols-5">
        <div class="xl:col-span-2">
          <div>
            <img :src="avatar1" class="mx-auto h-80 rounded-full" alt="" />
          </div>
        </div>
        ...
        <div class="xl:col-span-3">
          <span class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary"
            >Our About</span
          >
          <h2 class="mt-4 text-4xl font-medium text-default-950">Entrepreneur of the Year</h2>
          <h4 class="mt-5 text-xl font-medium text-default-400">
            Hello! I'm Diego, a self-taught and award-winning Digital Designer and Developer with more than fifteen years of professional experience.
            I began my journey in my childhood bedroom and honed my skills at renowned digital agencies like nexum AG.
          </h4>
