  ...
  <section class="bg-default-100 py-10 lg:py-20">
    <div class="container">
      <div class="mx-auto text-center">
        <h2 class="mt-5 text-3xl font-medium text-default-950 md:text-4xl/tight">Let's Explore the Next Major Innovation</h2>
        ...
        <div class="mt-7 flex flex-wrap items-center justify-center gap-6">
          ...
          <a href="#" class="flex items-center justify-center gap-2 rounded-lg bg-black px-8 py-3 text-lg text-white transition-all"
            >Discuss Project
            <MoveRightIcon class="h-7 w-7" />
          </a>
        </div>
