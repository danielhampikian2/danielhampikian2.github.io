        ...
        <div class="bg-[url('../images/landing/marketing-2/bg-1.png')] bg-cover bg-no-repeat px-6 py-20">
          <div class="mx-auto max-w-2xl text-center">
            <span class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary"
              >Domain names</span
            >
            <h2 class="mt-5 text-3xl font-medium text-default-950 md:text-4xl">Stay updated with our weekly newsletter.</h2>
            ...
            <form class="mx-auto mt-6 max-w-2xl space-y-2">
              <div class="relative">
                ...
                <small class="text-default-700"
                  >By submitting the form, you acknowledge and agree to our Terms & Conditions and Privacy Policy.</small
                >
              </div>
            </form>
          </div>
