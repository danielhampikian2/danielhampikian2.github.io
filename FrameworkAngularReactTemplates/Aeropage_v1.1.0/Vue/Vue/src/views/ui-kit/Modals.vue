              ...
              <div class="m-3 opacity-0 transition-all hs-overlay-open:opacity-100 hs-overlay-open:duration-500 sm:mx-auto sm:w-full sm:max-w-lg">
                <div border-default-200="" class="flex flex-col rounded border border-default-200 bg-white shadow-sm dark:bg-default-50">
                  <div class="flex items-center justify-between border-b border-default-200 px-4 py-3">
                    <h3 class="font-bold text-default-800">Modal Heading</h3>
                    <button
                      type="button"
                      class="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded text-sm text-default-500 transition-all hover:text-default-400 focus:outline-none focus:ring-2 focus:ring-default-400 focus:ring-offset-2 focus:ring-offset-default-50"
                      data-hs-overlay="#hs-basic-modal"
                    >
                  ...
                  <div class="overflow-y-auto p-4">
                    <h5 class="mb-2.5 text-base font-semibold">Text in a modal</h5>
                    <p class="mb-4 text-sm font-medium">Duis mollis, est non commodo luctus, nisi erat porttitor ligula.</p>
                    <hr class="my-5 border-default-200" />
                    <h5 class="mb-2.5 text-base font-semibold">Overflowing text to show scroll behavior</h5>
