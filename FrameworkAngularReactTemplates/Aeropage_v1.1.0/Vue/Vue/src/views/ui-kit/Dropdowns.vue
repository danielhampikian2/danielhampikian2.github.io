        ...
        <div class="p-6">
          <div class="flex flex-wrap gap-2">
            <div class="hs-dropdown [--auto-close:inside]">
              ...
              >
                Radio
                <ChevronDownIcon class="ms-1 h-4 w-4" />
              </button>
                ...
                <form class="">
                  <div class="mb-3 space-y-1">
                    ...
                    <span class="inline-block"
                      ><small id="emailHelp" class="form-text text-sm text-default-700">We'll never share your email with anyone else.</small></span
                    >
                  </div>
                  <div class="mb-3 space-y-1">
            ...
            <div class="hs-dropdown">
              ...
              >
                <span class="inline-flex h-9 w-9 items-center overflow-hidden rounded-full"
                  ><img src="@/assets/images/avatars/img-1.jpg" alt="" class="h-full max-w-full"
                /></span>
                Jesica
                <ChevronDownIcon class="h-4 w-4" />
              </button>
                ...
                <ul class="flex flex-col gap-1 py-1.5">
                  <li class="mx-1.5">
                    <a
                      ...
                      href="#"
                    >
                      <UserCircleIcon class="me-2 h-4 w-4" />
                      Profile</a
                    >
                  </li>
                  <li class="mx-1.5">
                  ...
                  <li class="mx-1.5">
                    <a
                      ...
                      href="#"
                    >
                      <MicIcon class="me-2 h-4 w-4" />
                      Support</a
                    >
                  </li>
                  <hr class="border-default-200" />
                  <li class="mx-1.5">
                    <a class="flex items-center rounded px-3 py-2 text-default-600 transition-all hover:bg-red-500/20 hover:text-red-500" href="#">
            ...
            <div class="hs-dropdown">
              <button
                class="hs-dropdown-toggle inline-flex h-10 w-10 items-center justify-center rounded-md bg-primary text-white transition-all duration-500 hover:bg-primary-700"
              >
...
import { ChevronDownIcon, UserCircleIcon, CogIcon, MicIcon, LogOutIcon, MoreVerticalIcon } from 'lucide-vue-next'
</script>
