<template>
  <section id="home" class="bg-cover bg-no-repeat bg-[url('../images/other/bg-lines-2.png')] dark:bg-[url('../images/other/bg-lines-2-dark.png')]">
    <div class="grid xl:grid-cols-5 grid-cols-1 gap-6 items-end">
      <div class="xl:col-span-3">
        <Swiper
          ...
          :speed="1000"
        >
          <SwiperSlide class="relative" v-for="(feature, idx) in featureData" :key="`creative-featureImg-${idx + 1}`">
        ...
        <div class="absolute inset-x-0 bottom-8 z-10">
          <div class="flex items-center justify-end gap-5 relative pe-10">
            <div class="cre-button-prev">
              <div class="h-14 w-14 rounded-full border border-default-300 bg-default-50 hover:bg-primary flex items-center justify-center">
