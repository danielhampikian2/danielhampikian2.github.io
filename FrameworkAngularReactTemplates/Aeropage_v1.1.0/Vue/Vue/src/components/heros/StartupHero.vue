      ...
      <div class="relative">
        <div class="grid items-center gap-6 lg:grid-cols-2">
          <div class="max-w-xl">
            ...
            >
            <h2 class="my-5 text-4xl font-medium text-default-950 md:text-5xl/tight">Easily, Quickly Craft Your Stunning Online Presence</h2>
            <p class="mb-10 text-base">
              We're a renowned studio with expertise in design and engineering. Our objective is to bring significance to the work process.
            </p>
            ...
            <div class="relative">
              ...
              <div data-hs-carousel='{"loadingClasses": "opacity-0","isAutoPlay": true}' class="relative z-20">
                <div class="hs-carousel relative min-h-[350px] w-full overflow-hidden rounded-lg lg:min-h-[650px]">
                  <div class="hs-carousel-body absolute bottom-0 start-0 top-0 flex flex-nowrap opacity-0 transition-transform duration-700">
                    <div class="hs-carousel-slide">
                      <img :src="startupImg11" alt="" class="h-full w-full" />
                    </div>
                    <div class="hs-carousel-slide">
                      <img :src="startupImg12" alt="" class="h-full w-full" />
                    </div>
                  </div>
                </div>
                ...
                <div class="hidden xl:block">
                  ...
                  >
                    <div
                      class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-primary shadow transition-all hover:bg-primary hover:text-white"
                    >
...
import startupImg11 from '@/assets/images/landing/startup/img-11.jpg'
import startupImg12 from '@/assets/images/landing/startup/img-12.jpg'
</script>
