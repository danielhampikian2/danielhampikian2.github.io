  ...
  <section id="home" class="flex items-center justify-center bg-default-100 py-20 dark:bg-default-50 lg:py-44">
    <div class="container">
      <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <div>
          <span class="truncate border border-default-200 px-3 py-2 text-xs text-default-950 md:text-base"
            >Limited-time offer until Friday: $1.99 per month</span
          >
          <h2 class="mt-5 text-4xl font-medium text-default-950 md:text-6xl/tight">Place your trust in the world's no.1 web hosting provider.</h2>
          <p class="my-6 text-base">Already have a website? Revive it with our industry-leading load times.</p>
...
import hostingImg4 from '@/assets/images/landing/hosting/4.svg'
</script>
