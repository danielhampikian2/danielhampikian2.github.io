<script lang="ts">
	import type { PricingType } from '$lib/types/landing';
	import { DotIcon } from 'lucide-svelte';

	export let plan: PricingType;
</script>
		...
		<div class="group">
			<div
				...
				<div class="bg-white p-6 dark:bg-default-50">
					<h5
						class="text-center text-2xl font-medium text-default-950">
						{ plan.title }
					</h5>
					<p
					...
					<div
						...
						<h2 class="text-5xl font-semibold">
							<sup class="text-xl">$</sup>{ plan.price }
						</h2>
						<div>
						...
						<div class="group">
							<div
								...
								<div
									...
									<a class="button bg-primary text-white" href={null}>Get Started</a>
								</div>
							</div>
