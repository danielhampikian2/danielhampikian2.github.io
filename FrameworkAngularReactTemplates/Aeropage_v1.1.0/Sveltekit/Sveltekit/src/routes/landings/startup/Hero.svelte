<script lang="ts">
	...
	import { startupImg11, startupImg12 } from '$lib/utilities/images';
</script>
				...
				<div>
					<div class="relative">
						<div class="relative z-10 hidden xl:block">
							<div
								class="before:absolute before:-end-10 before:-top-10 before:-z-10 before:h-28 before:w-28 before:bg-[url('../images/other/dot.svg')]"></div>
						</div>
