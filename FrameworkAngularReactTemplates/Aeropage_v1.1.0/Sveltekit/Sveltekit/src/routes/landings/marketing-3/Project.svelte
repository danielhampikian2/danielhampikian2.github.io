<script lang="ts">
	import { marketing3Img2, marketing3Img3 } from '$lib/utilities/images';
		...
		<div
			...
			<div class="grid items-center gap-6 lg:grid-cols-2">
              ...
              <span
					...
					<a
						href={null}
						class="inline-flex items-center justify-center gap-2 rounded-md bg-primary px-6 py-2 text-white transition-all duration-300 hover:bg-primary-700">Read
						More
	...
	<div class="container">
		<div
			...
			<div class="grid items-center gap-6 lg:grid-cols-2">
              ...
              <span
								class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Exploratory Studies</span>
					<h2 class="mt-4 text-3xl font-medium text-default-950">
