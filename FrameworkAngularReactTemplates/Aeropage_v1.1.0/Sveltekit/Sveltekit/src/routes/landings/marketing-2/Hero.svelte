<script lang="ts">
	import { marketing2Bg2Dark, marketing2Bg2Light, marketing2Img1 } from '$lib/utilities/images';
</script>
...
<section
	...
	<div class="absolute inset-0">
		<img src={marketing2Bg2Light} class="h-full w-full dark:hidden" alt="" />
	...
	<div class="container">
		<div class="relative">
			<div class="grid items-center gap-6 lg:grid-cols-2">
              ...
              <span
								class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">startups Marketing</span>
