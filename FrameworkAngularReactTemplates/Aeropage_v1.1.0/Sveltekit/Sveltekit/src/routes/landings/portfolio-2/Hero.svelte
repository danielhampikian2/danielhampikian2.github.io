<script lang="ts">
	import { avatar1, avatar2, avatar3, portfolio2Img10 } from '$lib/utilities/images';
</script>
            ...
            <span
				...
				<div class="mt-8 flex items-center gap-6">
					<div class="flex -space-x-2">
						<img
							class="inline-block h-12 w-12 rounded-full bg-white shadow-md ring-2 ring-default-50" src={avatar1}
							alt="" />
						<img
							class="inline-block h-12 w-12 rounded-full bg-white shadow-md ring-2 ring-default-50" src={avatar2}
							alt="" />
						<img
							class="inline-block h-12 w-12 rounded-full bg-white shadow-md ring-2 ring-default-50" src={avatar3}
							alt="" />
						<button
							class="h-12 w-12 rounded-full border border-primary/50 bg-primary/30 font-medium text-primary shadow-md backdrop-blur-md">
							80+
						</button>
					</div>
