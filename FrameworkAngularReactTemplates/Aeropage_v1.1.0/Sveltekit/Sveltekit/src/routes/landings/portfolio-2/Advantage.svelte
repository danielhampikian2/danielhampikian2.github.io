<script lang="ts">
	import { FigmaIcon, InstagramIcon, LayersIcon, LinkedinIcon, TriangleIcon, TwitterIcon } from 'lucide-svelte';
				...
				<div class="mx-auto text-center">
					<div
						...
						<div class="text-center flex items-center flex-col">
							<svelte:component this={item.icon} class="h-10 w-10 text-default-950" />
