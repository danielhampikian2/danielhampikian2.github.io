<script lang="ts">
	...
	import { hostingImg3, hostingImg5 } from '$lib/utilities/images';
</script>
	...
	<div class="container">
		<div class="grid items-center gap-6 md:grid-cols-2">
			...
			<div>
              ...
              <span
								class="absolute -bottom-0 h-px w-7/12 rounded bg-primary/80 transition-all duration-500 group-hover:w-full"></span>
