	...
	<div class="container">
		<div>
			<div class="mb-10 flex items-end justify-center">
              ...
              <span
								class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">Services</span>
			...
			<div
				...
				<div class="grid 2xl:grid-cols-2">
					<div class="divide-y divide-default-200">
						{#each serviceData.slice(0, 3) as service}
					...
					<div class="divide-y divide-default-200 border-t border-default-200 2xl:border-s 2xl:border-t-0">
						{#each serviceData.slice(3, serviceData.length) as service}
							<div class="flex items-center justify-between p-6">
								<h3 class="text-2xl font-medium text-default-950">
									{ service.title }
								</h3>
			...
			<div class="mt-7 flex justify-center">
				<a href={null}
					 class="inline-flex items-center justify-center gap-2 rounded-md border border-default-200 px-8 py-2 text-default-950 backdrop-blur-3xl transition-all hover:border-primary hover:bg-primary hover:text-white">Get
					Solution
