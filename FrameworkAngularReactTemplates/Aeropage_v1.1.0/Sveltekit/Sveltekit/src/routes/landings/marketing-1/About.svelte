<script lang="ts">
	import { MoveRightIcon, PlayIcon } from 'lucide-svelte';
	import { marketing1Img5 } from '$lib/utilities/images';
</script>
	...
	<div class="grid items-center gap-6 lg:grid-cols-2">
		<div class="relative h-[650px]">
			<div
				...
				style={`background-image:url(${marketing1Img5})`}>
		...
		<div class="py-10">
            ...
            <span
							class="rounded-md border border-primary bg-primary/20 px-3 py-1 text-xs font-medium uppercase tracking-wider text-primary">About</span>
				...
				<div class="group mt-6">
					<a href={null} class="text-lg text-default-950"
					>Read More
						<MoveRightIcon
