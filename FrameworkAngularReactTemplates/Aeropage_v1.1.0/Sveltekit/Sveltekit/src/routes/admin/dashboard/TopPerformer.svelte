<script lang="ts">
	...
	import { avatar1, avatar2, avatar3, avatar4, avatar7, avatar8, avatar9 } from '$lib/utilities/images';
	import { LogOutIcon, MoreVerticalIcon, PencilIcon, Trash2Icon } from 'lucide-svelte';
	...
	<div
		...
		{#each userData as user}
			<div class="flex items-center p-2.5">
				<img src={user.image} class="me-3 h-12 rounded-full" alt="" />
				<div class="flex-grow">
				...
				<div class="h-4">
					<div class="hs-dropdown relative inline-flex [--placement:left-top] rtl:[--placement:bottom-left]">
						...
						>
							...
							<a class="mx-1.5 flex items-center rounded px-3 py-2 text-red-500 transition-all hover:bg-red-500/10"
								 href={null}>
