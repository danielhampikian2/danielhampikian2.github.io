<script lang="ts">
	import { ChevronDownIcon, UserCircleIcon, CogIcon, MicIcon, LogOutIcon, MoreVerticalIcon } from 'lucide-svelte';
	import { avatar1 } from '$lib/utilities/images';
</script>
		...
		<div class="rounded-lg border border-default-200 bg-white dark:bg-default-50">
			...
			<div class="p-6">
							...
							<form class="">
								...
								<div class="mb-3 flex items-center gap-2">
									<input
										...
										id="checkmeout0"
									/>
									<label class="inline-block text-sm font-medium text-default-700" for="checkmeout0">Check me out
										!</label>
								</div>
								<button
									type="submit"
                ...
                <span class="inline-flex h-9 w-9 items-center overflow-hidden rounded-full"
								><img src={avatar1} alt="" class="h-full max-w-full"
								/></span>
							Jesica
							<ChevronDownIcon class="h-4 w-4" />
						</button>
