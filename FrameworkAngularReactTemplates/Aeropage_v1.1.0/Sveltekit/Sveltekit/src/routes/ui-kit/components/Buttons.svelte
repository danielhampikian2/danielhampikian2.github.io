<script lang="ts">
	import { FacebookIcon, InstagramIcon, LinkedinIcon, DribbbleIcon, CodesandboxIcon, GithubIcon } from 'lucide-svelte';
</script>
	...
	<div class="space-y-4">
		<div class="rounded-lg border border-default-200 bg-white dark:bg-default-50">
			...
			<div class="p-6">
				<div class="flex flex-wrap items-center gap-2">
					...
					>
					<a href={null}
						 class="inline-block rounded-md bg-red-600 px-6 py-2 text-center text-base text-white transition-all hover:bg-red-700">Red</a>
					<a href={null}
					...
					>
					<a href={null}
						 class="inline-block rounded-md bg-sky-600 px-6 py-2 text-center text-base text-white transition-all hover:bg-sky-700">Sky</a>
					<a href={null}
		...
		<div class="rounded-lg border border-default-200 bg-white dark:bg-default-50">
			...
			<div class="p-6">
				<div class="flex flex-wrap items-center gap-2">
					...
					>
					<a href={null}
						 class="inline-block rounded-md px-6 py-2 text-center text-base text-gray-500 transition-all hover:bg-gray-500/20">Gray</a>
					<a href={null}
						 class="inline-block rounded-md px-6 py-2 text-center text-base text-emerald-600 transition-all hover:bg-emerald-500/20"
					>Emerald</a
					>
					<a href={null}
						 class="inline-block rounded-md px-6 py-2 text-center text-base text-red-600 transition-all hover:bg-red-500/20">Red</a>
					<a href={null}
						 class="inline-block rounded-md px-6 py-2 text-center text-base text-blue-600 transition-all hover:bg-blue-500/20">Blue</a>
					<a href={null}
						 class="inline-block rounded-md px-6 py-2 text-center text-base text-yellow-500 transition-all hover:bg-yellow-500/20"
					>Yellow</a
					>
					<a href={null}
						 class="inline-block rounded-md px-6 py-2 text-center text-base text-sky-600 transition-all hover:bg-sky-500/20">Sky</a>
					<a href={null}
						 class="inline-block rounded-md px-6 py-2 text-center text-base text-cyan-600 transition-all hover:bg-cyan-500/20">Cyan</a>
					<a href={null}
					...
					>
					<a href={null}
						 class="inline-block rounded-md px-6 py-2 text-center text-base text-gray-700 transition-all hover:bg-gray-700/20">Dark</a>
					<a href={null}
						 class="inline-block rounded-md px-6 py-2 text-center text-base text-gray-100 transition-all hover:bg-gray-200/20">Light</a>
				</div>
			</div>
		</div>
		...
		<div class="rounded-lg border border-default-200 bg-white dark:bg-default-50">
			...
			<div class="p-6">
				<div class="flex flex-wrap items-center gap-2">
					...
					>
					<a href={null}
						 class="inline-block rounded-full px-6 py-2 text-center text-base text-gray-500 transition-all hover:bg-gray-500/20">Gray</a>
					<a href={null}
						 class="inline-block rounded-full px-6 py-2 text-center text-base text-emerald-600 transition-all hover:bg-emerald-500/20"
					>Emerald</a
					>
					<a href={null}
						 class="inline-block rounded-full px-6 py-2 text-center text-base text-red-600 transition-all hover:bg-red-500/20">Red</a>
					<a href={null}
						 class="inline-block rounded-full px-6 py-2 text-center text-base text-blue-600 transition-all hover:bg-blue-500/20">Blue</a>
					<a href={null}
						 class="inline-block rounded-full px-6 py-2 text-center text-base text-yellow-500 transition-all hover:bg-yellow-500/20"
					>Yellow</a
					>
					<a href={null}
						 class="inline-block rounded-full px-6 py-2 text-center text-base text-sky-600 transition-all hover:bg-sky-500/20">Sky</a>
					<a href={null}
						 class="inline-block rounded-full px-6 py-2 text-center text-base text-cyan-600 transition-all hover:bg-cyan-500/20">Cyan</a>
					<a href={null}
					...
					>
					<a href={null}
						 class="inline-block rounded-full px-6 py-2 text-center text-base text-gray-700 transition-all hover:bg-gray-700/20">Dark</a>
					<a href={null}
						 class="inline-block rounded-full px-6 py-2 text-center text-base text-gray-100 transition-all hover:bg-gray-200/20">Light</a>
				</div>
			</div>
		</div>
		...
		<div class="rounded-lg border border-default-200 bg-white dark:bg-default-50">
			...
			<div class="p-6">
				<div class="flex flex-wrap items-center gap-2">
					<a href={null}
						 class="inline-block rounded bg-primary px-4 py-1 text-center text-sm text-white transition-all hover:bg-primary-700">Small</a>
					<a href={null}
						 class="inline-block rounded-md bg-primary px-6 py-2 text-center text-base text-white transition-all hover:bg-primary-700"
					>Default</a
					>
		...
		<div class="rounded-lg border border-default-200 bg-white dark:bg-default-50">
			...
			<div class="p-6">
				<div class="flex flex-wrap items-center gap-2">
					<a href={null}
						 class="inline-flex h-10 w-10 items-center justify-center rounded-md bg-blue-500 text-white transition-all hover:bg-blue-600">
