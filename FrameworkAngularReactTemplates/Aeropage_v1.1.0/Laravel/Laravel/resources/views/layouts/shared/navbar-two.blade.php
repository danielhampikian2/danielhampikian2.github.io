                                ...
                                <ul class="grid grid-cols-2 gap-1">
                                    <li>
                                        <a
                                            ...
                                            href="{{ route('second', ['landings', 'agency-1']) }}"
                                        >Agency</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'agency-2']) }}"
                                        >Agency Two</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'charity']) }}"
                                        >Charity</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'company']) }}"
                                        >Company</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'creative']) }}"
                                        >Creative</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'ebook']) }}"
                                        >eBook</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'finance']) }}"
                                        >Finance</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'hosting']) }}"
                                        >Hosting</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'marketing-1']) }}"
                                        >Marketing</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'marketing-2']) }}"
                                        >Marketing Two</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'marketing-3']) }}"
                                        >Marketing Three</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'photography']) }}"
                                        >Photography</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'portfolio-1']) }}"
                                        >Portfolio</a>
                                    </li>
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'portfolio-2']) }}"
                                        >Portfolio Two</a>
                                    </li>
                                    <li>
                                        <a
                                    ...
                                    <li>
                                        <a
                                            class="flex items-center rounded px-3 py-2 text-sm font-medium text-default-600 transition-all hover:bg-default-400/10 hover:text-default-700"
                                            href="{{ route('second', ['landings', 'web-designer']) }}"
                                        >Web Designer</a>
                                    </li>
                                </ul>
                            </div>
